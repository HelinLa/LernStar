...
BANDNAME="FELO Physik 8 · Realschule NRW"
DATEINAME="FELO_Physik_8_Realschule_NRW"
FUSS="FELO Physik 8 · Forscherheft"
...
def lb_cover():
    ...
    h.tracked(W/2,330,"PHYSIK 8",DIDOT(46),INK,4)
    h.tracked(W/2,410,"REALSCHULE NRW",COP(16),GOLD_D,6); h.orn(W/2,452,150)
    z=["Lösungen zu allen 25 Forscherseiten","Lösungen der Übungsseiten und Kapiteltests",
...
def build_lehrerband():
    ...
    try:
        ...
        w.add_metadata({"/Title":"FELO PHYSIK 8 – Realschule NRW – Lehrerband",
                        "/Author":"Abdullah Lala","/Creator":"FELO",
                        "/Subject":"Lösungen und Erwartungshorizonte zum Forscherheft Klasse 8"})
...
def build_ebook(src, dst, nav, qrpages=None, seitentexte=None,
    ...
    w._root_object[NameObject("/PageMode")]=NameObject("/UseOutlines")
    w.add_metadata({"/Title":"FELO PHYSIK 8 – Forscherheft Realschule NRW",
                    ...
                    "/Keywords":"FELO, Physik, Klasse 8, Realschule NRW, Forscherheft, Elektrizität, Spannung, Widerstand, Geschwindigkeit, Fassung 1.1, Stand 2026-08-28",
                    "/Creator":"FELO"})
...
if __name__=="__main__":
    ...
    out=os.path.join(bd,"FELO_Physik_8_Realschule_NRW_Druck%s.pdf"%("_weiss" if WEISS else ""))
    pages[0].save(out,"PDF",resolution=150,save_all=True,append_images=pages[1:])
    ...
    if "--druck" in sys.argv:
        import shutil; ziel=os.path.expanduser("~/Desktop/FELO_Physik_8_Realschule_NRW_Druck.pdf")
        shutil.copy2(out,ziel); print("Druckfassung zusätzlich:",ziel)
    try:
        eb=os.path.expanduser("~/Desktop/FELO_Physik_8_Realschule_NRW.pdf")
        try:
            ...
            eb=os.path.expanduser("~/Desktop/FELO_Physik_8_Realschule_NRW_NEU.pdf")
            build_ebook(out, eb, nav, qrpages, seitentexte, mess_start, mess_starts,
                        toc_pn, bk_start)
