# -*- coding: utf-8 -*-
"""Bildauftraege Klasse 7 als PDF: eine Seite je fehlendem Einstiegsbild.
...
def _fuss(h, pn, gesamt):
    ...
    h.T(ML + 34, H - 48, "FORSCHERHEFT PHYSIK · KLASSE 7 · BILDAUFTRÄGE", COP(9), GOLD_D)
    if pn:
...
def deckblatt(n):
    ...
    _kopf(h, "WAS ZU TUN IST", f"{ZAHLWORT.get(n, str(n)).capitalize()} Bilder für Klasse 7")
    y = 208
    ...
    kasten = [
        ("Wohin", "In den Ordner „Arbeitsheft-Bilder 7 Klasse“ auf dem Schreibtisch. "
...
if __name__ == "__main__":
    ...
    w.add_metadata({"/Title": "Bildaufträge · Forscherheft Physik Klasse 7",
                    "/Author": "Abdullah Lala", "/Subject": "Fehlende Einstiegsbilder"})
    ziel = os.path.expanduser("~/Desktop/Bildauftraege_Klasse7.pdf")
