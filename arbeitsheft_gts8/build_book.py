# -*- coding: utf-8 -*-
"""FeLabs PHYSIK · Gesamtschule NRW: Kapitel mit Test dahinter.
...
ABLAGE = os.path.expanduser("~/Desktop/Projekt KI Verkauf Physik /Arbeitshefte Gesamtschule")
...
DATEINAME = f"FeLabs_Physik_{KL}_{SFORM_DT}"
