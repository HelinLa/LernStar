...
_KL = str(plan.KLASSE)
_ORDNER = f"FeLabs-Bilder Gesamtschule {_KL}"
...
if __name__ == "__main__":
    ...
    w.add_metadata({"/Title": f"Bildaufträge · FeLabs Physik {_KL} Gesamtschule",
                    "/Author": "Abdullah Lala", "/Subject": "Fehlende Einstiegsbilder"})
    ziel = os.path.expanduser(f"~/Desktop/Bildauftraege_GTS{_KL}.pdf")
