...
BANDNAME="FELO Physik 10 · Realschule NRW"
DATEINAME="FELO_Physik_10_Realschule_NRW"
FUSS="FELO Physik 10 · Forscherheft"
...
def lb_cover():
    ...
    h.tracked(W/2,330,"PHYSIK 10",DIDOT(46),INK,4)
...
def build_lehrerband():
    ...
    try:
        ...
        w.add_metadata({"/Title":"FELO PHYSIK 10 – Realschule NRW – Lehrerband",
                        "/Author":"Abdullah Lala","/Creator":"FELO",
                        "/Subject":"Lösungen und Erwartungshorizonte zum Forscherheft Klasse 10"})
...
def build_ebook(src, dst, nav, qrpages=None, seitentexte=None,
    ...
    w._root_object[NameObject("/PageMode")]=NameObject("/UseOutlines")
    w.add_metadata({"/Title":"FELO PHYSIK 10 – Forscherheft Realschule NRW",
                    "/Author":"Abdullah Lala",
                    "/Subject":"Kräfte · Bewegung · Energie, Arbeit & Leistung · Kraftwerke, Energieversorgung & Klimaschutz",
                    "/Keywords":"FELO, Physik, Klasse 10, Realschule NRW, Forscherheft, Magnetismus, Motor, Induktion, Radioaktivität, Kernenergie, Fassung 1.0, Stand 2026-08-30",
                    "/Creator":"FELO"})
...
if __name__=="__main__":
    ...
    out=os.path.join(bd,"FELO_Physik_10_Realschule_NRW_Druck%s.pdf"%("_weiss" if WEISS else ""))
    pages[0].save(out,"PDF",resolution=150,save_all=True,append_images=pages[1:])
    ...
    if "--druck" in sys.argv:
        import shutil; ziel=os.path.expanduser("~/Desktop/FELO_Physik_10_Realschule_NRW_Druck.pdf")
        shutil.copy2(out,ziel); print("Druckfassung zusätzlich:",ziel)
    try:
        eb=os.path.expanduser("~/Desktop/FELO_Physik_10_Realschule_NRW.pdf")
        try:
            ...
            eb=os.path.expanduser("~/Desktop/FELO_Physik_10_Realschule_NRW_NEU.pdf")
            build_ebook(out, eb, nav, qrpages, seitentexte, mess_start, mess_starts,
                        toc_pn, bk_start)
