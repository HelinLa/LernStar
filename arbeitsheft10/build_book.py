...
if __name__=="__main__":
    ...
    if "--druck" in sys.argv:
        import shutil; ziel=os.path.join(ABLAGE, f"FELO_Physik_10_Realschule_NRW_Druck.pdf")
        shutil.copy2(out,ziel); print("Druckfassung zusätzlich:",ziel)
    try:
        eb=os.path.join(ABLAGE, f"FELO_Physik_10_Realschule_NRW.pdf")
        try:
            ...
            eb=os.path.join(ABLAGE, f"FELO_Physik_10_Realschule_NRW_NEU.pdf")
            build_ebook(out, eb, nav, qrpages, seitentexte, mess_start, mess_starts,
                        toc_pn, bk_start)
