...
def _fuss(h, pn, gesamt):
    ...
    h.T(ML + 34, H - 48, "FORSCHERHEFT PHYSIK · KLASSE 9 · BILDAUFTRÄGE", COP(9), GOLD_D)
    if pn:
...
def deckblatt(n):
    ...
    kasten = [
        ("Wohin", "In den Ordner „Arbeitsheft-Bilder 9 Klasse“ auf dem Schreibtisch. "
...
if __name__ == "__main__":
    ...
    w.add_metadata({"/Title": "Bildaufträge · Forscherheft Physik Klasse 9",
                    "/Author": "Abdullah Lala", "/Subject": "Fehlende Einstiegsbilder"})
    ziel = os.path.expanduser("~/Desktop/Bildauftraege_Klasse9.pdf")
