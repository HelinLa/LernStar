...
SCHREIBTISCH = ["Arbeitsheft-Bilder 5:6Klasse", "Arbeitsheft-Bilder 5/6 Klasse",
                "Bilder für Arbeitsheft 5 Klasse", "Bilder fuer Arbeitsheft 5 Klasse"]
...
def _kennung(dateiname):
    ...
    # Kennung am Dateianfang - aus den Themen DIESES Hefts. Vorher stand hier ein
    # festes Muster (l1-5, s1-6 ...), durch das "l6 ...png" und "s7 ...png" fielen.
