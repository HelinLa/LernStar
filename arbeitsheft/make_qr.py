...
m1 und m4 zeigen beide auf "magnetfeld", s2 und s6 beide auf "stromkreis-lampe".
...
print("Beispiel s1:", sim_url('s1'))
print("Beispiel m4:", sim_url('m4'), " (gleiche Simulation wie m1, andere Frage)")
