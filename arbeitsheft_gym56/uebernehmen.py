...
def pruefen(seiten):
    ...
    fehler = []
    for s in seiten:
        # Klasse 5/6: kuerzere Einstiege (34-52 Woerter) sind hier richtig -
        # formregeln prueft klassenabhaengig, plan.KLASSE ist "5/6".
        for tid, art, txt in formregeln.pruefe_seite(s, klasse=5):
