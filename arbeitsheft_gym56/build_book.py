# -*- coding: utf-8 -*-
"""FeLabs PHYSIK · Gymnasium NRW (G9): Kapitel mit Test dahinter.
...
DATEINAME=f"FeLabs_Physik_{KL.replace('/', '_')}_{SFORM_DT}"   # 5/6 darf keinen Pfad ergeben
...
def build_ebook(src, dst, nav, qrpages=None, seitentexte=None,
    ...
    w.add_metadata({"/Title":f"FeLabs PHYSIK {KL} – Forscherheft {SFORM}",
                    ...
                    "/Subject":FACHGEBIETE,
                    "/Keywords":f"FeLabs, Physik, Klasse {KL}, {SFORM}, Forscherheft, {INHALTSFELDER}, {FACHGEBIETE}, Fassung 1.0",
                    "/Creator":"FeLabs"})
