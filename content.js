    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          ...
          { name:'Schatten', diff:1, video:'schatten.mp4',
  ...
  klasse5_rs: {
    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          { isChapter:true, name:'💡 Licht & Schatten' },
          { name:'Lichtquellen, Lichtausbreitung & Schatten', diff:1, video:'licht-und-sehen.mp4', explanation:'Lichtquellen senden Licht aus (Sonne, Glühlampe, Kerze). Licht breitet sich geradlinig aus. Trifft es auf ein undurchsichtiges Objekt, entsteht ein Schatten. Kernschatten: kein Licht. Halbschatten: nur Teillicht.' },
          { name:'Wie können wir einen Gegenstand sehen?', diff:1, exp:'sehen', video:'gegenstand-sehen.mp4', explanation:'Wir sehen einen Gegenstand nur, wenn Licht von ihm in unser Auge gelangt (Sender–Gegenstand–Empfänger). In der Simulation schaltest du das Licht an und aus und wählst leuchtende Körper (Lampe, Kerze, Sonne) oder beleuchtete Körper (Buch, Apfel, Mond). Du entdeckst: Beleuchtete Körper sieht man im Dunkeln nicht – der Mond leuchtet nicht selbst, er wirft Sonnenlicht zurück.' },
          { name:'Wie breitet sich Licht aus?', diff:1, exp:'lichtausbreitung', video:'lichtausbreitung.mp4', explanation:'Licht breitet sich geradlinig aus. In der Simulation stehen zwischen Lampe und Schirm zwei Blenden mit Loch. Du verschiebst die Löcher – das Licht kommt nur durch, wenn Lampe und beide Löcher auf einer geraden Linie liegen. Den geraden Weg des Lichts stellt man als Lichtstrahl dar.' },
          { name:'Wie entsteht ein Schatten?', diff:1, exp:'schatten-entstehung', video:'schatten.mp4', explanation:'Ein Schatten entsteht, weil Licht geradlinig verläuft und ein undurchsichtiger Körper es blockiert. In der Simulation bewegst du die Lampe und entfernst den Gegenstand. Du entdeckst: Ohne Gegenstand gibt es keinen Schatten, und der Schatten liegt immer der Lichtquelle gegenüber – bewegst du die Lampe nach oben, wandert der Schatten nach unten.' },
          { name:'Wovon hängt die Größe des Schattens ab?', diff:1, exp:'schatten-groesse', video:'schatten-groesse.mp4', explanation:'Die Größe eines Schattens hängt von zwei Abständen ab: Je weiter der Schirm von der Lampe entfernt ist, desto größer der Schatten. Und je näher der Gegenstand an der Lampe steht, desto größer der Schatten. In der Simulation veränderst du nur einen Abstand, misst die Schattengröße und findest die Regel selbst heraus.' },
          { name:'Kern- und Halbschatten', diff:1, exp:'kern-halbschatten', video:'kern-halbschatten.mp4', explanation:'Bei einer punktförmigen Lichtquelle entsteht nur ein scharfer Kernschatten. Bei einer ausgedehnten Lichtquelle kommt am Rand ein Halbschatten hinzu: In den Kernschatten gelangt gar kein Licht, in den Halbschatten nur Licht von einem Teil der Quelle. In der Simulation vergrößerst du die Lichtquelle und beobachtest, wie der weiche Halbschatten entsteht.' },
          { isChapter:true, name:'🧲 Magnetismus' },
          { name:'Magnete & magnetische Felder', diff:1, video:'magnete-felder.mp4', explanation:'Magnete haben einen Nord- und einen Südpol. Gleiche Pole stoßen sich ab, ungleiche ziehen sich an. Magnetische Feldlinien verlaufen vom Nordpol zum Südpol. Eisen, Nickel und Kobalt sind magnetisch. Ein Kompass zeigt zum Erdmagnetpol (geografischer Südpol = magnetischer Nordpol).' },
          { name:'Welche Stoffe zieht ein Magnet an?', diff:1, exp:'magnet-stoffe', video:'magnet-stoffe.mp4', explanation:'Nicht jedes Material wird von einem Magneten angezogen. In der Simulation testest du nacheinander Eisen, Stahl, Nickel, Kupfer, Aluminium, Holz, Plastik und Glas, sortierst sie in zwei Gruppen und findest die Regel selbst: Magnetisch sind nur Eisen, Nickel und Kobalt (und Stahl). Achtung – Kupfer und Aluminium sind Metalle, aber nicht magnetisch!' },
          { name:'Wie wirken Magnetpole aufeinander?', diff:1, exp:'magnetpole', video:'magnetpole.mp4', explanation:'Zwei Stabmagnete: Gleiche Pole (N–N oder S–S) stoßen sich ab, ungleiche Pole (N–S) ziehen sich an. In der Simulation schaltest du zwischen den Polen um und misst mit einem Kraftmesser, wie die Kraft vom Abstand abhängt: Je kleiner der Abstand, desto größer die Kraft.' },
          { name:'Wie sieht ein Magnetfeld aus?', diff:1, exp:'magnetfeld', video:'magnetfeld.mp4', explanation:'Der Bereich um einen Magneten heißt Magnetfeld. Man stellt es mit Feldlinien dar, die außerhalb vom Nordpol zum Südpol verlaufen. In der Simulation bewegst du einen Prüfkompass um den Magneten und beobachtest, wie sich die Nadel entlang des Feldes ausrichtet. Wo die Linien dicht sind (nah an den Polen), ist das Feld am stärksten.' },
          { name:'Wie funktioniert ein Kompass?', diff:1, exp:'kompass', video:'kompass.mp4', explanation:'Die Kompassnadel ist ein kleiner drehbarer Magnet. Sie richtet sich nach dem Magnetfeld der Erde aus und zeigt nach Norden. In der Simulation stößt du die Nadel an (sie pendelt zurück nach Norden) und bringst einen Magneten heran – dann dreht sich die Nadel zu ihm. Eisen oder Magnete in der Nähe lassen einen Kompass falsch anzeigen.' },
          { name:'Der Elektromagnet – wie stark ist er?', diff:1, exp:'elektromagnet', video:'elektromagnet.mp4', explanation:'Eine Spule mit Eisenkern wird zum Magneten, sobald Strom fließt. In der Simulation misst du die Tragkraft (Anzahl Büroklammern) und veränderst dabei nur eine Größe: mehr Windungen machen den Magneten stärker, mehr Stromstärke ebenfalls. Du findest heraus: Die Tragkraft ist proportional zur Windungszahl und zur Stromstärke.' },
          { isChapter:true, name:'⚡ Einfacher Stromkreis' },
          { name:'Stromkreis & Schaltzeichen', diff:1, video:'stromkreis-schaltzeichen.mp4', explanation:'Ein Stromkreis braucht: Energiequelle (Batterie), Leiter (Kabel), Verbraucher (Lampe) – und muss geschlossen sein. Unterbricht man den Kreis, erlischt die Lampe. Schalter unterbrechen den Stromkreis. Schaltzeichen: Batterie =⊣⊢, Lampe = ⊗, Schalter = / (offen) oder — (geschlossen).' },
          { name:'Wann leuchtet eine Lampe?', diff:1, exp:'stromkreis-lampe', video:'stromkreis-lampe.mp4', explanation:'Eine Lampe leuchtet nur im geschlossenen Stromkreis. In der Simulation öffnest und schließt du den Schalter und unterbrichst ein Kabel. Du entdeckst: Schon eine einzige Unterbrechung stoppt den Strom – dann bleibt die Lampe dunkel. Es wird nur mit ungefährlicher Batterie-Kleinspannung gearbeitet.' },
          { name:'Welche Stoffe leiten Strom?', diff:1, exp:'leiter-nichtleiter', video:'leiter-nichtleiter.mp4', explanation:'Setze verschiedene Materialien in eine Lücke des Stromkreises: Leitet der Stoff, leuchtet die Lampe (Leiter); leitet er nicht, bleibt sie aus (Nichtleiter). In der Simulation sortierst du Kupfer, Eisen, Alu, Graphit, Holz, Plastik, Glas und Gummi und findest die Regel: Metalle und Graphit leiten – Holz, Plastik, Glas und Gummi nicht.' },
          { name:'Wie zeichnet man einen Stromkreis?', diff:1, exp:'schaltplan', video:'schaltplan.mp4', explanation:'Derselbe Stromkreis lässt sich als echtes Bild oder als Schaltplan mit Schaltzeichen darstellen. In der Simulation schaltest du zwischen beiden Ansichten um, betätigst den Schalter (beide reagieren gleich) und ordnest die Schaltzeichen den Bauteilen zu: Batterie ⊣⊢, Lampe ⊗, Schalter und Leitung.' },
          { name:'Reihenschaltung', diff:2, exp:'reihenschaltung-rs', video:'reihenschaltung.mp4', explanation:'In der Reihenschaltung liegen die Lampen hintereinander in einem einzigen Stromweg. Du veränderst die Anzahl der Lampen (je mehr, desto schwächer leuchtet jede) und drehst eine Lampe heraus – dann gehen alle aus, weil der einzige Stromweg unterbrochen ist.' },
          { name:'Parallelschaltung', diff:2, exp:'parallelschaltung-rs', video:'parallelschaltung.mp4', explanation:'In der Parallelschaltung hat jede Lampe einen eigenen Stromweg mit eigenem Schalter. Du schaltest die Lampen einzeln und entdeckst: Jede lässt sich unabhängig steuern und leuchtet mit voller Helligkeit. Deshalb sind Geräte im Haushalt parallel geschaltet.' },
    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          ...
          { name:'Sind Temperatur und Wärme das Gleiche?', diff:1, exp:'temperatur-waerme', video:'temperatur-waerme.mp4', explanation:'Die Temperatur (in °C) sagt, wie warm etwas ist. Die Wärme ist übertragene Energie und hängt von der Menge UND der Temperatur ab. In der Simulation vergleichst du zwei Wassergefäße: Ein kleines heißes kann weniger Wärme haben als ein großes warmes. Bringst du beide in Kontakt, fließt Wärme vom warmen zum kalten Wasser bis zur Mischtemperatur.' },
          { name:'Wie funktioniert ein Thermometer?', diff:1, exp:'thermometer', video:'thermometer.mp4', explanation:'Die Flüssigkeit im Thermometer dehnt sich beim Erwärmen aus und steigt in der Röhre. An der Skala liest man die Temperatur ab. In der Simulation veränderst du die Temperatur oder tauchst das Thermometer in verschiedene Proben und liest die Werte ab – geeicht mit den Fixpunkten 0 °C (Eiswasser) und 100 °C (kochendes Wasser).' },
          { name:'Was geschieht beim Erwärmen von Stoffen?', diff:1, exp:'waermeausdehnung', video:'waermeausdehnung.mp4', explanation:'Beim Erwärmen bewegen sich die Teilchen schneller und brauchen mehr Platz – der Stoff dehnt sich aus (Wärmeausdehnung). In der Simulation erwärmst du Festkörper, Flüssigkeit und Gas und vergleichst: Gase dehnen sich am stärksten aus, Festkörper am wenigsten. Das erklärt Dehnungsfugen an Brücken.' },
          { name:'Wie verändern sich Aggregatzustände?', diff:1, exp:'aggregatzustaende', video:'aggregatzustaende.mp4', explanation:'Wasser kann fest (Eis), flüssig oder gasförmig (Dampf) sein. In der Simulation erwärmst und kühlst du Wasser und beobachtest die Teilchen. Bei 0 °C schmilzt/erstarrt es, bei 100 °C verdampft/kondensiert es. Die Übergänge heißen Schmelzen, Erstarren, Verdampfen und Kondensieren.' },
          { name:'Wie wird Wärme übertragen?', diff:2, exp:'waermeuebertragung', video:'waermeuebertragung.mp4', explanation:'Wärme gelangt auf drei Wegen von warm nach kalt: Wärmeleitung (durch Kontakt, gut in Metallen), Wärmeströmung/Konvektion (warme Flüssigkeit oder Luft steigt auf) und Wärmestrahlung (ohne Materie, z. B. von der Sonne). In der Simulation wählst du die Art und beobachtest, wie sich die Wärme bewegt.' },
          { name:'Welches Material dämmt am besten?', diff:2, exp:'daemmung', video:'daemmung.mp4', explanation:'Heißes Wasser steht in verschiedenen Dämmstoffen (ohne, Alufolie, Papier, Watte, Styropor). In der Simulation misst du die Temperatur über 10 Minuten und vergleichst die Abkühlkurven. Der beste Dämmstoff (Styropor) hält die Wärme am längsten – seine Kurve fällt am flachsten.' },
          { name:'Warum erwärmen sich dunkle Flächen stärker?', diff:2, exp:'dunkle-flaechen', video:'dunkle-flaechen.mp4', explanation:'Dunkle Flächen absorbieren (schlucken) viel Sonnenstrahlung und werden warm; helle und blanke Flächen reflektieren viel und bleiben kühl. In der Simulation bestrahlst du verschieden gefärbte Flächen und vergleichst ihre Endtemperatur und die zurückgeworfenen Strahlen.' },
          { isChapter:true, name:'🔊 Schall & Hören' },
          { name:'Wie entsteht ein Ton?', diff:1, exp:'ton-entsteht', video:'ton-entsteht.mp4', explanation:'Ein Ton entsteht durch einen schwingenden Gegenstand (eine Schallquelle). In der Simulation schlägst du eine Saite an: Sie schwingt und sendet Schall aus. Hältst du sie fest, hört der Ton sofort auf. Schallquellen sind z. B. Saiten, Stimmgabeln, Lautsprecher und die Stimmbänder.' },
          { name:'Wovon hängt die Lautstärke ab?', diff:1, exp:'lautstaerke', video:'lautstaerke.mp4', explanation:'Die Lautstärke hängt von der Amplitude ab – also davon, wie stark die Schwingung ausschlägt. In der Simulation veränderst du die Amplitude: Große Amplitude bedeutet laut, kleine Amplitude leise. Die Tonhöhe bleibt dabei gleich. Die Lautstärke misst man in Dezibel (dB).' },
          { name:'Wovon hängt die Tonhöhe ab?', diff:1, exp:'tonhoehe', video:'tonhoehe.mp4', explanation:'Die Tonhöhe hängt von der Frequenz ab – also davon, wie oft die Schwingung pro Sekunde ist. In der Simulation veränderst du die Frequenz: Hohe Frequenz bedeutet hoher Ton, niedrige Frequenz tiefer Ton. Die Lautstärke bleibt dabei gleich. Die Frequenz misst man in Hertz (Hz).' },
          { name:'Wie breitet sich Schall aus?', diff:2, exp:'schallausbreitung', video:'schallausbreitung.mp4', explanation:'Schall braucht einen Stoff mit Teilchen, um sich auszubreiten. In der Simulation wählst du Luft, Wasser, Metall oder Vakuum. Die Teilchen geben die Schwingung weiter – im Vakuum gibt es keine Teilchen, also keinen Schall. In festen Stoffen und Flüssigkeiten ist Schall schneller als in Luft.' },
          { name:'Wie funktioniert das Ohr?', diff:1, exp:'ohr', video:'ohr.mp4', explanation:'Das Ohr ist der Empfänger des Schalls. Die Ohrmuschel sammelt den Schall, der Gehörgang leitet ihn zum Trommelfell, das dann schwingt. Die Gehörknöchelchen übertragen die Schwingung, die Schnecke wandelt sie in Nervensignale um, und der Hörnerv leitet sie zum Gehirn. In der Simulation verfolgst du diesen Weg.' },
          { name:'Wie können wir uns vor Lärm schützen?', diff:2, exp:'laermschutz', video:'laermschutz.mp4', explanation:'Lärm schadet dem Gehör, wenn er zu laut ist und zu lange dauert (ab etwa 85 dB). In der Simulation veränderst du Lautstärke und Abstand, setzt Gehörschutz auf und dämpfst den Raum – und siehst, wie viel Lärm am Ohr ankommt und ob das gefährlich ist. So bewertest du Schutzmaßnahmen.' },
          { isChapter:true, name:'🌍 Sonne, Erde & Mond' },
          { name:'Wie entstehen Tag und Nacht?', diff:1, exp:'tag-nacht', video:'tag-nacht.mp4', explanation:'Tag und Nacht entstehen, weil sich die Erde in etwa 24 Stunden einmal um sich selbst dreht. Die der Sonne zugewandte Seite hat Tag, die abgewandte Seite Nacht. In der Simulation drehst du die Erde und verfolgst deinen Standort durch Tag und Nacht – nicht die Sonne wandert, sondern die Erde dreht sich.' },
          { name:'Wie entstehen die Jahreszeiten?', diff:2, exp:'jahreszeiten', video:'jahreszeiten.mp4', explanation:'Die Erde umläuft die Sonne, und ihre Achse ist geneigt und zeigt immer in dieselbe Richtung. Dadurch trifft das Sonnenlicht die Nordhalbkugel im Sommer steil (warm) und im Winter flach (kühl). In der Simulation bewegst du die Erde durch das Jahr. Wichtig: Nicht der Abstand zur Sonne macht die Jahreszeiten, sondern die geneigte Erdachse.' },
          { name:'Warum verändert der Mond sein Aussehen?', diff:1, exp:'mondphasen', video:'mondphasen.mp4', explanation:'Der Mond leuchtet nicht selbst – die Sonne beleuchtet immer eine Hälfte von ihm. Beim Umlauf um die Erde sehen wir unterschiedlich viel dieser hellen Hälfte: die Mondphasen (Neumond, zunehmender Mond, Vollmond, abnehmender Mond). In der Simulation bewegst du den Mond um die Erde und siehst im Fenster die jeweilige Phase.' },
          { name:'Wie entsteht eine Sonnenfinsternis?', diff:2, exp:'sonnenfinsternis', video:'sonnenfinsternis.mp4', explanation:'Bei einer Sonnenfinsternis steht der Mond (bei Neumond) genau zwischen Sonne und Erde und wirft seinen Schatten auf die Erde. Im Kernschatten ist die Sonne ganz verdeckt, im Halbschatten teilweise. In der Simulation richtest du den Mond aus und lässt seinen Schatten auf die Erde fallen. Weil die Mondbahn geneigt ist, passiert das nur selten.' },
          { name:'Wie entsteht eine Mondfinsternis?', diff:2, exp:'mondfinsternis', video:'mondfinsternis.mp4', explanation:'Bei einer Mondfinsternis steht die Erde (bei Vollmond) zwischen Sonne und Mond, und der Schatten der Erde fällt auf den Mond – er verdunkelt sich und wird oft rötlich (Blutmond). In der Simulation schiebst du den Mond in den Erdschatten. Anders als bei den Mondphasen ist hier wirklich ein Schatten im Spiel.' },
          { isChapter:true, name:'🔦 Optik: Reflexion' },
          { name:'Reflexionsgesetz & ebene Spiegel', diff:1, video:'reflexion.mp4', explanation:'Einfallswinkel = Reflexionswinkel (beide gemessen zur Normalen). Am ebenen Spiegel entsteht ein virtuelles, aufrechtes, seitenverkehrtes Bild, das gleich weit hinter dem Spiegel liegt wie das Objekt davor.' },
          { isChapter:true, name:'🔌 Stromkreis & Elektromagnetismus' },
          { name:'Reihenschaltung & Parallelschaltung', diff:1, video:'reihe-parallel.mp4', explanation:'Reihenschaltung: alle Bauteile hintereinander, gleicher Strom, Spannungen addieren sich. Fällt ein Bauteil aus → alles aus. Parallelschaltung: Bauteile nebeneinander, gleiche Spannung, Ströme addieren sich. Fällt ein Bauteil aus → Rest funktioniert weiter.' },
          { name:'Elektromagnet', diff:1, video:'elektromagnet-6.mp4', explanation:'Eine stromdurchflossene Spule (Drahtwicklung) erzeugt ein Magnetfeld. Mit Eisenkern → viel stärkeres Magnetfeld → Elektromagnet. Je mehr Windungen und je mehr Strom, desto stärker. Vorteil: abschaltbar (kein Strom → kein Magnetfeld). Anwendungen: Türklingel, Lautsprecher, Kran.' },
        ],
        exercises:[
    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          ...
          { name:'Wie macht ein kleines Loch ein Bild? (Lochkamera)', diff:2, exp:'lochkamera', video:'lochkamera.mp4', explanation:'In einer Lochkamera entsteht durch ein kleines Loch ein umgekehrtes Bild, weil sich Licht geradlinig ausbreitet und die Strahlen sich im Loch kreuzen. In der Simulation veränderst du Gegenstandsweite, Bildweite und Lochgröße und entdeckst: Größere Kameralänge macht das Bild größer, ein kleines Loch macht es scharf (aber dunkler). Es gilt B/G = b/g.' },
          { name:'Wie bündelt eine Sammellinse das Licht?', diff:2, exp:'sammellinse', video:'sammellinse.mp4', explanation:'Eine Sammellinse bündelt paralleles Licht in einem Punkt, dem Brennpunkt. Der Abstand von der Linse bis dorthin ist die Brennweite. In der Simulation veränderst du die Brennweite und siehst, wie sich der Brennpunkt verschiebt. Im Brennpunkt ist das Licht am hellsten und heißesten – deshalb kann man mit einer Lupe Papier entzünden.' },
          { name:'Wann entsteht ein vergrößertes oder verkleinertes Bild?', diff:2, exp:'bild-linse', video:'bild-linse.mp4', explanation:'Verschiebt man einen Gegenstand vor einer Sammellinse, ändert sich das Bild: Weiter als die doppelte Brennweite (g > 2f) → verkleinert, umgekehrt, reell. Zwischen F und 2F → vergrößert, umgekehrt, reell. Näher als die Brennweite (g < f) → vergrößert, aufrecht, virtuell (Lupe). In der Simulation konstruierst du das Bild mit zwei Strahlen.' },
          { name:'Wie funktioniert eine Lupe?', diff:1, exp:'lupe', video:'lupe.mp4', explanation:'Eine Lupe ist eine Sammellinse. Steht der Gegenstand näher als die Brennweite, entsteht ein vergrößertes, aufrechtes, virtuelles Bild. In der Simulation hältst du den Gegenstand unterschiedlich nah an die Lupe – je näher an der Brennweite, desto größer das Bild. Weiter als die Brennweite kippt das Bild und es gibt kein Lupenbild mehr.' },
          { name:'Wie funktioniert eine Kamera?', diff:2, exp:'kamera', video:'kamera.mp4', explanation:'Eine Kamera besteht aus Linse, Blende und Sensor. Ein weit entfernter Gegenstand wird als umgekehrtes, verkleinertes, reelles Bild auf dem Sensor abgebildet. In der Simulation stellst du durch den Abstand Linse–Sensor scharf und regelst mit der Blende die Helligkeit – ganz ähnlich wie beim menschlichen Auge.' },
          { name:'Wie funktioniert das Auge?', diff:2, exp:'auge', video:'auge.mp4', explanation:'Das Auge arbeitet wie eine Kamera: Die Linse bündelt das Licht, die Pupille wirkt als Blende und auf der Netzhaut entsteht ein umgekehrtes Bild (das Gehirn dreht es um). Zum Scharfstellen verformt sich die Linse (Akkommodation). In der Simulation veränderst du Abstand und Pupille und beobachtest das Bild auf der Netzhaut.' },
          { name:'Wie korrigiert eine Brille Sehfehler?', diff:2, exp:'brille', video:'brille.mp4', explanation:'Bei Kurzsichtigkeit liegt das Bild vor der Netzhaut – eine Zerstreuungslinse korrigiert das. Bei Weitsichtigkeit liegt es hinter der Netzhaut – eine Sammellinse hilft. In der Simulation wählst du den Sehfehler und setzt die passende Brille auf, bis das Bild scharf auf der Netzhaut liegt.' },
          { isChapter:true, name:'🪞 Spiegel, Brechung & Farben' },
          { name:'Wie entsteht ein Spiegelbild?', diff:1, exp:'spiegelbild', video:'spiegelbild.mp4', explanation:'Am ebenen Spiegel entsteht ein virtuelles, aufrechtes, seitenverkehrtes Bild, das genauso weit hinter dem Spiegel liegt wie der Gegenstand davor. In der Simulation verschiebst du den Gegenstand und verfolgst den Lichtstrahl: Es gilt das Reflexionsgesetz – Einfallswinkel = Reflexionswinkel (beide zum Lot gemessen).' },
          { name:'Warum erscheint ein Gegenstand im Wasser verschoben?', diff:2, exp:'brechung', video:'brechung.mp4', explanation:'An der Grenzfläche zwischen Luft und Wasser wird das Licht gebrochen. Das Auge verlängert den einfallenden Strahl geradlinig, deshalb erscheint ein Gegenstand im Wasser höher (flacher), als er wirklich ist. In der Simulation verschiebst du die Tiefe und vergleichst wahre und scheinbare Lage – darum greift man im Wasser oft daneben.' },
          { name:'Wovon hängt die Stärke der Brechung ab?', diff:2, exp:'brechungswinkel', video:'brechungswinkel.mp4', explanation:'Je größer der Einfallswinkel, desto größer der Brechungswinkel. Beim Eintritt in einen dichteren Stoff wird das Licht zum Lot hin gebrochen, und Glas bricht stärker als Wasser. In der Simulation stellst du den Einfallswinkel ein und wechselst zwischen Wasser und Glas.' },
          { name:'Wie funktioniert ein Lichtleiter?', diff:2, exp:'totalreflexion', video:'totalreflexion.mp4', explanation:'Trifft Licht im Glas sehr schräg auf die Grenzfläche (ab dem Grenzwinkel), wird es vollständig zurückgeworfen – Totalreflexion. So bleibt Licht in einem Lichtleiter (Glasfaser) gefangen und läuft im Zickzack hindurch. In der Simulation veränderst du den Winkel und findest heraus, ab wann das Licht im Stab bleibt. Anwendung: Glasfaserkabel und Endoskope.' },
          { name:'Welche Farben stecken im weißen Licht?', diff:2, exp:'prisma', video:'prisma.mp4', explanation:'Ein Prisma zerlegt weißes Licht in die Spektralfarben Rot, Orange, Gelb, Grün, Blau und Violett, weil die Farben unterschiedlich stark gebrochen werden (Violett am meisten, Rot am wenigsten). In der Simulation schickst du weißes oder einfarbiges Licht durch das Prisma. Weiß ist also eine Mischung aller Spektralfarben.' },
          { name:'Wie entstehen die Farben eines Regenbogens?', diff:2, exp:'regenbogen', video:'regenbogen.mp4', explanation:'Im Regentropfen wird Sonnenlicht gebrochen, an der Rückwand reflektiert und beim Austritt in seine Farben zerlegt. Viele Tropfen zusammen bilden den farbigen Bogen (Rot außen, Violett innen). In der Simulation siehst du den Weg des Lichts in einem Tropfen und den ganzen Bogen – die Sonne steht dabei im Rücken.' },
          { name:'Wie entstehen Farben auf einem Bildschirm?', diff:2, exp:'farbmischung-additiv', video:'farbmischung-additiv.mp4', explanation:'Bildschirme mischen alle Farben aus den drei Lichtgrundfarben Rot, Grün und Blau (additive Farbmischung). Rot+Grün=Gelb, Grün+Blau=Cyan, Rot+Blau=Magenta, und alle drei zusammen ergeben Weiß. In der Simulation mischst du mit Reglern und findest heraus, wie ein Bildschirm Farben erzeugt.' },
          { isChapter:true, name:'🔭 Blick ins Weltall' },
          { name:'Sonne, Mond und Sterne – was leuchtet am Himmel?', diff:1, exp:'himmelskoerper', video:'himmelskoerper.mp4', explanation:'Nicht alle Himmelskörper leuchten selbst: Die Sonne und die Sterne sind Selbstleuchter (Sterne sind ferne Sonnen), der Mond und die Planeten leuchten nicht selbst – wir sehen sie nur, weil die Sonne sie beleuchtet. In der Simulation tippst du die Körper an und schaltest das Sonnenlicht aus: Sonne und Sterne strahlen weiter, Mond und Planet werden dunkel.' },
          { name:'Wie entstehen Tag und Nacht?', diff:1, exp:'tag-nacht', video:'tag-nacht.mp4', explanation:'Tag und Nacht entstehen, weil sich die Erde in etwa 24 Stunden einmal um sich selbst dreht. Die der Sonne zugewandte Seite hat Tag, die abgewandte Seite Nacht. In der Simulation drehst du die Erde und verfolgst deinen Standort durch Tag und Nacht – nicht die Sonne wandert, sondern die Erde dreht sich.' },
          { name:'Die Gravitation – warum fällt alles nach unten?', diff:2, exp:'gravitation', video:'gravitation.mp4', explanation:'Jede Masse zieht jede andere Masse an – das ist die Gravitation. Je größer die Masse eines Himmelskörpers, desto stärker zieht er. In der Simulation lässt du denselben 1-kg-Stein auf Mond, Erde und Jupiter fallen: Auf dem Jupiter fällt er am schnellsten, seine Gewichtskraft (F = m·g) ist dort am größten. Dieselbe Anziehung hält auch die Planeten auf ihrer Bahn um die Sonne.' },
          { name:'Wie holt ein Teleskop ferne Objekte näher heran?', diff:2, exp:'teleskop', video:'teleskop.mp4', explanation:'Ein Teleskop hat zwei Aufgaben: Es vergrößert das Bild (du siehst mehr Einzelheiten, z. B. Mondkrater) und es sammelt mit einer großen Öffnung viel Licht, sodass auch lichtschwache Objekte sichtbar werden. In der Simulation vergleichst du den Blick mit bloßem Auge und durchs Teleskop und veränderst die Öffnung – je größer, desto heller das Bild.' },
          { name:'Wie sieht man mit besonderen Teleskopen unsichtbares Licht?', diff:2, exp:'spezialteleskop', video:'spezialteleskop.mp4', explanation:'Himmelsobjekte senden nicht nur sichtbares Licht aus, sondern auch unsichtbare Strahlung: Infrarot (warmer Staub, Sternentstehung), Radiowellen (kalte Gaswolken, Galaxien) und Röntgenstrahlung (heiße, energiereiche Orte). In der Simulation betrachtest du dieselbe Region mit vier Teleskop-Arten. Weil die Luft Infrarot und Röntgen zurückhält, müssen solche Teleskope in den Weltraum – z. B. Hubble oder das James-Webb-Teleskop.' },
          { name:'Wie weit ist es im Weltall? (Lichtjahr)', diff:2, exp:'entfernungen', video:'entfernungen.mp4', explanation:'Entfernungen im Weltall sind riesig – deshalb misst man sie in Lichtzeit. Ein Lichtjahr ist keine Zeit, sondern eine Entfernung: die Strecke, die das Licht in einem Jahr zurücklegt. In der Simulation schickst du einen Lichtblitz zu Mond (1,3 s), Sonne (8 min), nächstem Stern (4,2 Lichtjahre) bis zur Andromeda-Galaxie (2,5 Mio. Lichtjahre). Weil das Licht so lange braucht, blicken wir in die Vergangenheit.' },
          { name:'Wie ist das Weltall aufgebaut? (Planeten, Sterne, Galaxien)', diff:1, exp:'weltall-aufbau', video:'weltall-aufbau.mp4', explanation:'Das Weltall ist gestuft aufgebaut: Planeten kreisen um einen Stern (Sonnensystem), viele Milliarden Sterne bilden eine Galaxie (unsere ist die Milchstraße), und viele Milliarden Galaxien bilden das Universum. In der Simulation zoomst du Schritt für Schritt heraus – vom Planeten Erde bis zum ganzen Universum – und siehst, wie jede Stufe unvorstellbar viel größer ist als die vorige.' },
          { name:'Was passiert bei einem schwarzen Loch?', diff:2, exp:'schwarzes-loch', video:'schwarzes-loch.mp4', explanation:'Ein schwarzes Loch entsteht, wenn sehr viel Masse auf winzigem Raum zusammengedrückt wird. Seine Anziehung ist so stark, dass nicht einmal Licht entkommt – deshalb ist es schwarz. Die Grenze, hinter der nichts mehr herauskommt, heißt Ereignishorizont. In der Simulation schickst du einen Lichtstrahl in verschiedenen Abständen vorbei: weit weg wird er nur leicht abgelenkt, sehr nah wird er verschluckt.' },
          { name:'Wie hat sich die Vorstellung vom Weltall verändert?', diff:2, exp:'weltbild', video:'weltbild.mp4', explanation:'Früher glaubten die Menschen, die Erde sei der Mittelpunkt und alles kreise um sie (geozentrisches Weltbild). Kopernikus, Galilei und Kepler zeigten mit neuen Beobachtungen (z. B. durch das Fernrohr): Die Sonne steht im Mittelpunkt, die Erde ist ein Planet wie die anderen (heliozentrisches Weltbild). In der Simulation vergleichst du beide Modelle – und siehst, wie Wissenschaft ihre Vorstellungen ändert, wenn neue Beweise auftauchen.' },
          { name:'Wie ist das Weltall entstanden? (Urknall)', diff:2, exp:'urknall', video:'urknall.mp4', explanation:'Nach der Urknalltheorie begann das Weltall vor etwa 13,8 Milliarden Jahren in einem sehr heißen, dichten Zustand und dehnt sich seitdem aus. Beweis: Fast alle Galaxien entfernen sich voneinander – wie Punkte auf einem Luftballon, den man aufbläst. In der Simulation startest du die Zeit beim Urknall und beobachtest, wie sich der Raum ausdehnt und die ersten Sterne und Galaxien entstehen.' },
          { isChapter:true, name:'🚀 Bewegung & Geschwindigkeit' },
          { name:'Geschwindigkeit v = s/t', diff:2, video:'geschwindigkeit.mp4', explanation:'Geschwindigkeit v = Strecke s / Zeit t. Einheit: m/s oder km/h. Umrechnen: 1 m/s = 3,6 km/h. Gleichförmige Bewegung: v = konstant, s = v · t. s-t-Diagramm: Steigung = Geschwindigkeit.' },
          { name:'Beschleunigung a = Δv/Δt', diff:2, video:'beschleunigung.mp4', explanation:'Beschleunigung a = Geschwindigkeitsänderung Δv / Zeit Δt. Einheit: m/s². Positiv = schneller werden, negativ = bremsen (Verzögerung). Aus dem Stand (v₀=0): v = a · t, s = ½·a·t².' },
          { isChapter:true, name:'⚖️ Kraft & Newton' },
          { name:'Kraft F = m · a und Einheit Newton', diff:2, video:'kraft-newton.mp4', explanation:'Kraft F = Masse m × Beschleunigung a. Einheit: 1 Newton (N) = 1 kg·m/s². Gewichtskraft: G = m · g (g ≈ 10 m/s² auf der Erde). Kräfte sind Vektoren (haben Betrag und Richtung). Reibung, Federkraft, Normalkraft sind verschiedene Kraftarten.' },
          { isChapter:true, name:'🔧 Hebelgesetz' },
          { name:'Hebelgesetz: F₁·l₁ = F₂·l₂', diff:2, video:'hebelgesetz.mp4', explanation:'Am Hebel gilt: Kraft × Kraftarm = Last × Lastarm. F₁·l₁ = F₂·l₂. Einseitiger Hebel: Kraftarm und Lastarm auf derselben Seite. Zweiseitiger Hebel: auf gegenüberliegenden Seiten. Anwendungen: Schere, Zange, Brechstange, Wippe.' },
        ],
        exercises:[
    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          ...
          { name:'Was ist elektrische Ladung?', diff:1, exp:'ladung', video:'ladung.mp4', explanation:'Es gibt zwei Ladungsarten: positiv (+) und negativ (−). Gleiche Ladungen stoßen sich ab, ungleiche ziehen sich an. In der Simulation gibst du zwei Kugeln eine Ladung und beobachtest an den Kraftpfeilen, ob sie sich anziehen oder abstoßen. So entsteht auch die Reibungselektrizität, wenn ein Luftballon an den Haaren gerieben wird.' },
          { name:'Was ist der elektrische Strom (Stromstärke)?', diff:2, exp:'stromstaerke', video:'stromstaerke.mp4', explanation:'Der elektrische Strom besteht aus bewegten Ladungen. Die Stromstärke I gibt an, wie viel Ladung pro Sekunde fließt (Einheit Ampere, A) und wird mit dem Amperemeter in Reihe gemessen. In der Simulation (ungefährliche 4,5-V-Kleinspannung) veränderst du, wie viel fließt, und öffnest den Schalter: Bei offenem Kreis ist I = 0 A. Mehr Ladungen pro Sekunde → größere Stromstärke → hellere Lampe.' },
          { name:'Was ist die elektrische Spannung?', diff:2, exp:'spannung', video:'spannung.mp4', explanation:'Die Spannung U ist der Antrieb der Quelle, der die Ladungen durch den Kreis treibt (Einheit Volt, V) und wird mit dem Voltmeter parallel gemessen. In der Simulation setzt du 1, 2 oder 3 Batteriezellen (je 1,5 V) ein: Mehr Zellen → mehr Volt → stärkerer Antrieb → hellere Lampe. Analogie: Spannung ist wie der Wasserdruck. (Nur ungefährliche Kleinspannung.)' },
          { name:'Wie misst man Stromstärke und Spannung?', diff:2, exp:'messen', video:'messen.mp4', explanation:'Das Amperemeter misst die Stromstärke und wird in Reihe eingebaut (der Strom fließt hindurch). Das Voltmeter misst die Spannung und wird parallel zum Bauteil angeschlossen. In der Simulation probierst du beide Geräte in beiden Anschlussarten aus und siehst die Folgen: Amperemeter parallel gibt einen Kurzschluss, Voltmeter in Reihe lässt die Lampe dunkel. (Nur ungefährliche Kleinspannung.)' },
          { name:'Wovon hängt die Stromstärke ab?', diff:2, exp:'stromabhaengigkeit', video:'stromabhaengigkeit.mp4', explanation:'Die Stromstärke hängt von zwei Größen ab: von der Spannung (Antrieb) und vom Widerstand (Bremse). In der Simulation veränderst du immer nur eine Größe und liest die Stromstärke ab: Mehr Spannung → mehr Strom, größerer Widerstand → weniger Strom. Das ist die Vorbereitung auf das Ohmsche Gesetz (I = U/R). (Nur ungefährliche Kleinspannung.)' },
          { name:'Spannung U (Volt) und Stromstärke I (Ampere)', diff:2, video:'u-i-groessen.mp4', explanation:'Spannung U: „Druck", der Ladungen antreibt. Einheit: Volt (V). Messgerät: Voltmeter (parallel). Stromstärke I: Menge der Ladungen pro Zeit. Einheit: Ampere (A). Messgerät: Amperemeter (in Reihe). Analogie: Spannung = Wasserdruck, Strom = Wassermenge.' },
          { isChapter:true, name:'🔌 Widerstand & Ohmsches Gesetz' },
          { name:'Was ist ein elektrischer Widerstand?', diff:1, exp:'widerstand', video:'widerstand.mp4', explanation:'Jedes Bauteil setzt dem Strom einen Widerstand entgegen. Bei gleicher Spannung gilt: großer Widerstand → kleiner Strom. In der Simulation (4,5 V Kleinspannung) baust du Bauteile mit verschiedenem Widerstand ein und berechnest R = U/I. Einheit: Ohm (Ω).' },
          { name:'Das Ohmsche Gesetz – die U-I-Kennlinie', diff:2, exp:'ohm-kennlinie', video:'ohm-kennlinie.mp4', explanation:'Bei einem festen Widerstand ist die Stromstärke proportional zur Spannung: Die U-I-Kennlinie ist eine Gerade durch den Ursprung. In der Simulation stellst du verschiedene Spannungen ein, setzt Messpunkte und siehst, dass R = U/I gleich bleibt. Es gilt das Ohmsche Gesetz U = R · I. (Nur ungefährliche Kleinspannung.)' },
          { name:'Wovon hängt der Widerstand eines Drahtes ab?', diff:2, exp:'draht', video:'draht.mp4', explanation:'Der Widerstand eines Drahtes ist größer, wenn der Draht länger oder dünner ist, und er hängt vom Material ab (Kupfer leitet gut, Konstantan schlecht). In der Simulation veränderst du immer nur eine Größe – Länge, Dicke oder Material – und beobachtest R und den Strom. Das erklärt, warum Kabel aus dickem Kupfer, Heizdrähte aber aus dünnem Konstantan bestehen.' },
          { name:'Reihenschaltung von Widerständen', diff:2, exp:'reihe-widerstand', video:'reihe-widerstand.mp4', explanation:'Schaltet man Widerstände hintereinander (in Reihe), addieren sich ihre Werte: R_ges = R₁ + R₂. Der Strom ist überall gleich, die Teilspannungen addieren sich zur Gesamtspannung. In der Simulation stellst du zwei Widerstände ein und siehst, dass der Gesamtwiderstand größer und der Strom kleiner wird. (Nur ungefährliche Kleinspannung.)' },
          { name:'Parallelschaltung von Widerständen', diff:2, exp:'parallel-widerstand', video:'parallel-widerstand.mp4', explanation:'Schaltet man Widerstände nebeneinander (parallel), liegt an beiden die gleiche Spannung und die Ströme addieren sich: I = I₁ + I₂. Weil es mehr Wege für den Strom gibt, wird der Gesamtwiderstand kleiner als der kleinste Einzelwiderstand. In der Simulation vergleichst du die Zweigströme mit dem Gesamtstrom. (Nur ungefährliche Kleinspannung.)' },
          { name:'Das Potentiometer – ein veränderbarer Widerstand', diff:1, exp:'potentiometer', video:'potentiometer.mp4', explanation:'Ein Potentiometer ist ein stufenlos einstellbarer Widerstand. Mit einem Schieberegler veränderst du den Widerstand: kleiner Widerstand → viel Strom → helle Lampe, großer Widerstand → wenig Strom → dunkle Lampe. So funktionieren Dimmer und Lautstärkeregler. In der Simulation regelst du Helligkeit und Strom stufenlos. (Nur ungefährliche Kleinspannung.)' },
          { name:'R = U/I – Ohmsches Gesetz', diff:2, video:'r-u-i.mp4', explanation:'Widerstand R = Spannung U / Stromstärke I. Einheit: Ohm (Ω). Ohmsches Gesetz: U = R · I (bei konstanter Temperatur). Umgestellt: I = U/R, R = U/I. Spezifischer Widerstand hängt vom Material ab.' },
          { isChapter:true, name:'💡 Elektrische Leistung' },
          { name:'Elektrische Leistung P = U · I', diff:2, exp:'elektrische-leistung', video:'elektrische-leistung.mp4', explanation:'Die elektrische Leistung P gibt an, wie viel Energie pro Sekunde umgesetzt wird: P = U · I (Einheit Watt, W). In der Simulation veränderst du Spannung und Strom und siehst, wie die Leistung und die Helligkeit steigen. Mehr Spannung oder mehr Strom bedeutet mehr Leistung. (Nur ungefährliche Kleinspannung.)' },
          { name:'Elektrische Energie E = P · t', diff:2, exp:'elektrische-energie', video:'elektrische-energie.mp4', explanation:'Die verbrauchte Energie hängt von der Leistung und der Zeit ab: E = P · t. Einheit: Wattstunde (Wh) bzw. Kilowattstunde (kWh), 1 kWh = 1000 Wh. In der Simulation wählst du ein Gerät und eine Betriebszeit und siehst, wie viel Energie umgesetzt wird – mehr Leistung oder längere Zeit bedeutet mehr Energie.' },
          { name:'Was kostet elektrische Energie? (kWh)', diff:1, exp:'stromkosten', video:'stromkosten.mp4', explanation:'Der Stromzähler misst die verbrauchte Energie in Kilowattstunden (kWh). Die Kosten berechnet man mit: Kosten = Energie (kWh) · Preis pro kWh. In der Simulation vergleichst du Geräte und Betriebszeiten und siehst die Kosten pro Tag und pro Jahr. So erkennst du, welche Geräte am meisten Strom kosten.' },
          { name:'Energie sparen im Haushalt', diff:1, exp:'energiesparen', video:'energiesparen.mp4', explanation:'Man spart Energie durch sparsame Geräte (LED statt Glühlampe), durch Ausschalten statt Standby und durch kürzere Laufzeiten. In der Simulation vergleichst du den Jahresverbrauch und die Kosten vorher und nachher und siehst, wie viele Kilowattstunden und Euro eine Maßnahme spart. Weniger kWh bedeutet weniger Kosten und schont die Umwelt.' },
          { name:'Gefahren des elektrischen Stroms & Schutz', diff:2, exp:'stromgefahren', video:'stromgefahren.mp4', explanation:'Zu viele Geräte an einer Steckdose ziehen zu viel Strom – die Sicherung unterbricht dann den Stromkreis und schützt vor Brand. In der Simulation (mit ungefährlicher Kleinspannung als Modell) schließt du immer mehr Geräte an und findest heraus, ab wann die Sicherung auslöst. Wichtig: Mit der Netzspannung (230 V) darf man niemals experimentieren – sie ist lebensgefährlich.' },
          { name:'P = U · I und Energie E = P · t', diff:2, video:'p-u-i-e-p-t.mp4', explanation:'Elektrische Leistung P = Spannung U × Stromstärke I. Einheit: Watt (W). Energie E = P · t. Einheit: Wh (Wattstunde) oder J (Joule). 1 kWh = 1.000 Wh. Stromkosten = E (kWh) × Preis pro kWh.' },
          { isChapter:true, name:'🚗 Geschwindigkeit & Bewegung' },
          { name:'Was bedeutet Geschwindigkeit?', diff:1, exp:'v-begriff', video:'v-begriff.mp4', explanation:'Die Geschwindigkeit sagt, wie schnell sich etwas bewegt. Ein Fahrzeug ist schneller, wenn es in der gleichen Zeit eine größere Strecke zurücklegt. In der Simulation lässt du zwei Autos um die Wette fahren und erkennst: Geschwindigkeit ist Strecke pro Zeit.' },
          { name:'Wie misst man eine Geschwindigkeit?', diff:2, exp:'v-messen', video:'v-messen.mp4', explanation:'Zum Messen der Geschwindigkeit braucht man die Strecke s (Maßband) und die Zeit t (Stoppuhr oder Lichtschranke). Ein Wagen fährt eine Messstrecke von 10 m, die Zeit wird gestoppt, und man berechnet v = s / t. In der Simulation misst du verschiedene Tempos und liest s, t und v ab.' },
          { name:'Wie berechnet man eine Geschwindigkeit? (v = s/t)', diff:2, exp:'v-formel', video:'geschwindigkeit.mp4', explanation:'Die Geschwindigkeit berechnet man mit v = s / t (Strecke geteilt durch Zeit), Einheit m/s. Mit dem Formeldreieck stellt man um: s = v · t und t = s / v. In der Simulation stellst du s und t ein und siehst, wie sich v ändert – doppelte Strecke bedeutet doppeltes v, doppelte Zeit bedeutet halbes v.' },
          { name:'Wie werden m/s und km/h umgerechnet?', diff:1, exp:'v-umrechnung', video:'v-umrechnung.mp4', explanation:'1 m/s = 3,6 km/h. Von m/s in km/h rechnet man mal 3,6, von km/h in m/s durch 3,6. In der Simulation stellst du eine Geschwindigkeit ein und siehst beide Einheiten nebeneinander, dazu Alltagsbeispiele wie Fußgänger, Radfahrer, Auto und ICE. So kannst du Geschwindigkeiten vergleichen.' },
          { name:'Was ist eine gleichförmige Bewegung?', diff:2, exp:'gleichfoermig-rs', video:'gleichfoermig.mp4', explanation:'Bei einer gleichförmigen Bewegung bleibt die Geschwindigkeit konstant: In gleichen Zeiten werden gleiche Strecken zurückgelegt. In der Simulation fährt ein Wagen mit gleichbleibendem Tempo und setzt jede Sekunde eine Marke – die Abstände sind alle gleich groß. Das Weg-Zeit-Diagramm ist eine Gerade.' },
          { name:'Was ist eine beschleunigte Bewegung?', diff:2, exp:'beschleunigung-rs', video:'beschleunigung.mp4', explanation:'Bei einer beschleunigten Bewegung ändert sich die Geschwindigkeit. Beim Beschleunigen werden die Sekunden-Marken immer größer, beim Bremsen immer kleiner. In der Simulation lässt du den Wagen Gas geben oder bremsen und vergleichst die Marken mit einer gleichförmigen Bewegung. Das Weg-Zeit-Diagramm ist dann eine Kurve.' },
          { name:'Wie stellt man eine Bewegung im Weg-Zeit-Diagramm dar?', diff:2, exp:'weg-zeit-diagramm', video:'weg-zeit-diagramm.mp4', explanation:'Im Weg-Zeit-Diagramm (s-t) steht die Zeit waagerecht und der Weg senkrecht. Eine steile Linie bedeutet schnelle Fahrt, eine flache Linie langsame Fahrt und eine waagerechte Linie Stillstand. In der Simulation fährt ein Wagen und du siehst gleichzeitig die passende Linie im Diagramm entstehen.' },
          { name:'Wie liest man ein Geschwindigkeit-Zeit-Diagramm?', diff:2, exp:'v-zeit-diagramm', video:'v-zeit-diagramm.mp4', explanation:'Im Geschwindigkeit-Zeit-Diagramm (v-t) bedeutet eine waagerechte Linie konstante Geschwindigkeit, eine ansteigende Linie Beschleunigen und eine fallende Linie Bremsen. Achtung: Anders als im s-t-Diagramm bedeutet waagerecht hier nicht Stillstand! In der Simulation vergleichst du konstante, beschleunigte und bremsende Bewegung.' },
          { name:'Wie funktioniert eine Geschwindigkeitsmessung im Straßenverkehr?', diff:2, exp:'verkehr-messung', video:'verkehr-messung.mp4', explanation:'Ein Radar- oder Laserblitzer misst die Geschwindigkeit eines Autos und vergleicht sie mit dem Tempolimit. Bei der Abschnittskontrolle misst man die Zeit über eine bekannte Strecke und rechnet die Durchschnittsgeschwindigkeit v = s / t aus. In der Simulation stellst du Tempo und Limit ein und findest heraus, wann ein Auto geblitzt wird.' },
        ],
        exercises:[
    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          ...
          { name:'Woran erkennt man, dass eine Kraft wirkt?', diff:1, exp:'kraft-wirkung', video:'kraft-wirkung.mp4', explanation:'Kräfte kann man nicht sehen – aber man erkennt sie an ihrer Wirkung. Eine Kraft kann einen Körper verformen, ihn in Bewegung setzen oder abbremsen oder seine Richtung ändern. In der Simulation wählst du eine dieser drei Wirkungen und lässt eine Kraft wirken: Die Knete wird eingedrückt (verformt), der ruhende Wagen rollt los und wird schneller (Bewegung), der rollende Ball wird zur Seite gelenkt (Richtung). So lernst du: Immer wenn sich Form, Tempo oder Richtung ändern, hat eine Kraft gewirkt.' },
          { name:'Was kann eine Kraft alles bewirken?', diff:1, exp:'kraft-wirkungen', video:'kraft-wirkungen.mp4', explanation:'Eine Kraft kann mehr als nur schieben und ziehen. Sie kann einen Körper verformen, seine Bewegung ändern (schneller oder langsamer machen) oder seine Richtung ändern. In der Simulation ordnest du Alltagssituationen – Schwamm ausdrücken, Wagen anschieben, Ball zurückschlagen, Fahrrad abbremsen – der passenden Wirkung zu und bekommst sofort eine Rückmeldung. Dabei erkennst du: Auch das Abbremsen ist eine Bewegungsänderung, und oft treten mehrere Wirkungen gleichzeitig auf.' },
          { name:'Wie misst man eine Kraft?', diff:1, exp:'kraftmesser', video:'kraftmesser.mp4', explanation:'Eine Kraft ist unsichtbar – aber man kann sie mit einem Federkraftmesser messen. Dabei nutzt man aus, dass sich eine Feder unter einer Kraft dehnt: Je größer die Kraft, desto länger wird die Feder. In der Simulation hängst du Gewichte (je 1 N) an die Feder und liest die Kraft am Zeiger auf der Newton-Skala ab. So lernst du: Die Dehnung der Feder ist das Maß für die Kraft, und die Einheit der Kraft ist das Newton (N). Rund 100 g ziehen mit etwa 1 N nach unten.' },
          { name:'Warum wird eine Feder gleichmäßig länger? (Hooke)', diff:2, exp:'federgesetz', video:'federgesetz.mp4', explanation:'Wenn man an eine Feder eine immer größere Kraft hängt, wird sie gleichmäßig länger. In der Simulation stellst du die Kraft der Reihe nach ein, nimmst Messpunkte auf und siehst: Die Messpunkte liegen auf einer Geraden durch den Ursprung – die Dehnung s ist proportional zur Kraft F. Das Verhältnis D = F/s (die Federkonstante) bleibt immer gleich. Das ist das Hooke\'sche Gesetz: F = D · s. Verdoppelt man die Kraft, verdoppelt sich auch die Dehnung.' },
          { name:'Ist „schwer“ dasselbe wie „viel Masse“?', diff:2, exp:'masse-gewicht', video:'masse-gewicht.mp4', explanation:'Masse und Gewichtskraft sind zwei verschiedene Dinge. Die Masse ist die Menge an Stoff in einem Körper (Einheit Kilogramm) und wird mit einer Waage gemessen – sie bleibt immer gleich. Die Gewichtskraft ist die Kraft, mit der die Erde den Körper nach unten zieht (Einheit Newton), und wird mit einem Kraftmesser gemessen. In der Simulation wählst du Körper mit verschiedener Masse und liest beides ab. Es gilt F = m · g mit dem Ortsfaktor g = 9,8 N/kg. Im Alltag meint „schwer“ eine große Gewichtskraft.' },
          { name:'Wäre ich auf dem Mond wirklich leichter?', diff:2, exp:'ortsfaktor', video:'ortsfaktor.mp4', explanation:'Auf dem Mond ist man nicht „weniger Masse“ – man wird nur schwächer angezogen. In der Simulation stehst du (Masse 60 kg) auf Mond, Erde und Jupiter. Deine Masse bleibt überall gleich, aber die Gewichtskraft F = m · g ändert sich, weil der Ortsfaktor g verschieden ist: Mond 1,6 · Erde 9,8 · Jupiter 24,8 N/kg. Auf dem Mond ist die Gewichtskraft nur etwa ein Sechstel wie auf der Erde – deshalb können Astronauten dort so hoch springen. „Leichter“ meint also eine kleinere Gewichtskraft, nicht weniger Masse.' },
          { name:'Hat eine Kraft auch eine Richtung?', diff:1, exp:'kraftpfeil', video:'kraftpfeil.mp4', explanation:'Zu einer Kraft gehört nicht nur, wie stark sie ist, sondern auch, in welche Richtung sie wirkt. In der Simulation stellst du den Betrag (2, 4 oder 6 N) und die Richtung ein und beobachtest den Kraftpfeil: Seine Länge zeigt den Betrag, seine Pfeilrichtung die Richtung, sein Startpunkt den Angriffspunkt. So lernst du: Eine Kraft ist eine gerichtete Größe und wird als Pfeil gezeichnet. Gleicher Betrag in verschiedene Richtungen bedeutet eine andere Wirkung.' },
          { name:'Was passiert, wenn zwei Kräfte gleichzeitig ziehen?', diff:2, exp:'kraefte-addieren', video:'kraefte-addieren.mp4', explanation:'Wirken zwei Kräfte an einem Körper, so rechnet man sie zu einer Gesamtkraft (Resultierenden) zusammen. In der Simulation stellst du für beide Kräfte Betrag und Richtung ein: Zeigen sie in dieselbe Richtung, werden die Beträge addiert. Zeigen sie in entgegengesetzte Richtungen, werden sie subtrahiert, und die Gesamtkraft zeigt in Richtung der größeren Kraft. Sind zwei gleich große Kräfte entgegengesetzt, ist die Gesamtkraft 0 N – das ist ein Gleichgewicht.' },
          { name:'Warum bewegt sich ein ruhender Körper nicht?', diff:2, exp:'kraefte-gleichgewicht', video:'kraefte-gleichgewicht.mp4', explanation:'An einer hängenden Lampe ziehen zwei Kräfte: die Gewichtskraft nach unten und die Haltekraft des Seils nach oben. In der Simulation veränderst du die Haltekraft und beobachtest die Gesamtkraft. Sind beide Kräfte gleich groß und entgegengesetzt, ist die Gesamtkraft 0 N – die Lampe bleibt in Ruhe. Das nennt man Kräftegleichgewicht. Ist eine Kraft größer, wird die Gesamtkraft ungleich null und die Lampe bewegt sich. So lernst du: „In Ruhe“ bedeutet nicht „keine Kräfte“, sondern Kräfte, die sich ausgleichen (wie beim Buch auf dem Tisch).' },
          { name:'Kraft und Gegenkraft: Warum drücke ich zurück?', diff:2, exp:'wechselwirkung', video:'wechselwirkung.mp4', explanation:'Kräfte treten immer paarweise auf. Übt ein Körper eine Kraft auf einen anderen aus, so wirkt eine gleich große Kraft zurück – das ist das Wechselwirkungsprinzip (actio = reactio). In der Simulation wählst du ein Beispiel (Eisläufer, Bootssprung, Rakete) und stößt ab: Du siehst zwei gleich große, entgegengesetzte Kraftpfeile und wie beide Partner auseinandergehen. Wichtig: Die zwei Kräfte wirken auf zwei verschiedene Körper – deshalb heben sie sich nicht auf (anders als beim Gleichgewicht). So erklärt sich auch, warum eine Rakete sogar im Weltall fliegt.' },
          { name:'Warum geht ein Stein über eine Rampe leichter hoch?', diff:2, exp:'schiefe-ebene', video:'schiefe-ebene.mp4', explanation:'Eine Rampe (schiefe Ebene) ist ein einfacher Kraftwandler. In der Simulation soll eine Last von 6 N auf dieselbe Höhe gebracht werden, und du veränderst die Steilheit der Rampe. Je flacher die Rampe, desto kleiner ist die nötige Zugkraft – dafür wird der Weg länger. Das Produkt Kraft × Weg bleibt bei jeder Rampe gleich und ist genauso groß wie beim senkrechten Heben. Merke: Eine Rampe spart Kraft, aber keine Arbeit – was man an Kraft spart, muss man an Weg zusetzen. Darum haben Rollstuhlrampen und Bergstraßen eine geringe Steigung.' },
          { name:'Warum bremst mich der Boden aus? (Reibung)', diff:1, exp:'reibung-rs', video:'reibung-rs.mp4', explanation:'Ein rollender Wagen bleibt von selbst stehen, weil die Reibung ihn abbremst. In der Simulation gibst du dem Wagen auf verschiedenen Untergründen (Eis, Holz, Teppich) denselben Anstoß und misst den Auslaufweg. Du erkennst: Die Reibungskraft wirkt immer entgegen der Bewegung. Je rauer der Untergrund, desto größer die Reibung und desto kürzer der Auslaufweg. Ohne Reibung würde der Wagen immer weiterrollen. Reibung ist mal hinderlich (sie bremst) und mal nützlich (Halt beim Gehen, Bremsen, Winterreifen).' },
          { isChapter:true, name:'🏃 Bewegung – schneller, langsamer, immer schneller' },
          { name:'Wie beschreibt man eine Bewegung? (Weg & Zeit)', diff:1, exp:'bewegung-beschreiben', video:'bewegung-beschreiben.mp4', explanation:'Um eine Bewegung genau zu beschreiben, braucht man zwei Größen: den zurückgelegten Weg (in Metern) und die dazu benötigte Zeit (in Sekunden). In der Simulation lässt du ein Auto fahren und nimmst Momentaufnahmen auf: Zu jedem Zeitpunkt gehört ein bestimmter Weg. So kannst du eine Bewegung auch dann beschreiben, wenn du nicht dabei warst – zum Beispiel mit einem Fahrplan oder einer Zeitmessung im Sport. Aus Weg und Zeit ergibt sich später die Geschwindigkeit.' },
          { name:'Was bedeutet „schnell“? (v = s/t)', diff:1, exp:'geschwindigkeit-rs', video:'geschwindigkeit-rs.mp4', explanation:'„Schnell“ heißt: in gleicher Zeit einen größeren Weg zurücklegen (oder die gleiche Strecke in kürzerer Zeit). In der Simulation lässt du zwei Autos um die Wette fahren und vergleichst nach gleicher Zeit ihren Weg. Das schnellere Auto ist weiter gekommen. Die Geschwindigkeit berechnet man mit v = s / t (Weg geteilt durch Zeit), die Einheit ist m/s. Je größer v, desto schneller. So arbeitet auch der Tacho im Auto.' },
          { name:'Was ist eine gleichförmige Bewegung?', diff:2, exp:'gleichfoermige-bewegung', video:'gleichfoermige-bewegung.mp4', explanation:'Bei einer gleichförmigen Bewegung bleibt die Geschwindigkeit konstant. In der Simulation fährt ein Wagen mit gleichbleibendem Tempo und setzt jede Sekunde eine Marke – alle Marken haben gleiche Abstände, weil in jeder Sekunde derselbe Weg zurückgelegt wird. Gleichzeitig baut sich ein s-t-Diagramm auf: Es entsteht eine Gerade durch den Ursprung, denn der Weg ist proportional zur Zeit (s = v · t). „Gleich schnell“ heißt also gleiche Wege pro Sekunde – der Wagen kommt dabei aber immer weiter.' },
          { name:'Wie lese ich aus einem Diagramm, was ein Körper gerade tut?', diff:2, exp:'s-t-diagramm-deuten', video:'s-t-diagramm-deuten.mp4', explanation:'Ein s-t-Diagramm (Weg-Zeit-Diagramm) verrät durch die Steilheit seiner Linie, wie sich ein Körper bewegt. In der Simulation wählst du zwischen einer steilen, einer flachen und einer waagerechten Linie und siehst oben, was der Körper dazu tut: steil = schnell, flach = langsam, waagerecht = Stillstand. Die Steigung der Linie ist genau die Geschwindigkeit und wird als Weg pro Zeit abgelesen: v = Δs / Δt. So kannst du allein aus dem Diagramm erkennen, ob ein Körper schnell, langsam oder gar nicht fährt.' },
          { name:'Was passiert, wenn ein Körper immer schneller wird?', diff:2, exp:'beschleunigung-jg9', video:'beschleunigung-jg9.mp4', explanation:'Beim Anfahren „gibt ein Auto Gas“ und wird immer schneller – das ist eine beschleunigte Bewegung. In der Simulation vergleichst du es mit einem gleichförmig fahrenden Auto: Beim Gasgeben werden die Sekundenmarken von Sekunde zu Sekunde weiter auseinander, weil in gleichen Zeiten immer größere Wege zurückgelegt werden. Die Geschwindigkeit nimmt also gleichmäßig zu. Im s-t-Diagramm ist das keine Gerade mehr, sondern eine nach oben gebogene Kurve – im Gegensatz zur Ursprungsgeraden der gleichförmigen Bewegung.' },
          { name:'Warum wird ein Auto gleichmäßig schneller – und was heißt das in Zahlen?', diff:2, exp:'beschleunigung-formel-jg9', video:'beschleunigung-formel-jg9.mp4', explanation:'Beschleunigt ein Körper gleichmäßig aus dem Stand, kommt in jeder Sekunde derselbe Geschwindigkeitsbetrag dazu. In der Simulation wählst du die Beschleunigung a (1, 2 oder 3 m/s²) und beobachtest am Tacho, wie die Geschwindigkeit gleichmäßig wächst. Es gilt v = a · t; die Beschleunigung a hat die Einheit m/s² (so viele m/s pro Sekunde). Im v-t-Diagramm entsteht dabei eine Gerade durch den Ursprung, deren Steigung die Beschleunigung ist – je größer a, desto steiler die Gerade. So kannst du z. B. die Geschwindigkeit nach 3 s direkt ausrechnen.' },
          { name:'Was ist der Unterschied zwischen schneller werden und langsamer werden?', diff:2, exp:'verzoegerung-jg9', video:'verzoegerung-jg9.mp4', explanation:'Beschleunigen und Bremsen sind im Grunde dasselbe – nur andersherum. In der Simulation schaltest du zwischen „Gas geben“ und „Bremsen“ um: Beim Gasgeben steigt die Geschwindigkeit und die v-t-Linie steigt an; beim Bremsen sinkt die Geschwindigkeit und die v-t-Linie fällt bis auf 0, das Auto kommt zum Stehen. Das Bremsen nennt man Verzögerung – es ist eine negative Beschleunigung (−a). So verstehst du, dass „langsamer werden“ nach denselben Regeln funktioniert wie „schneller werden“, nur mit umgekehrtem Vorzeichen.' },
          { name:'Warum braucht ein Auto zum Bremsen viel mehr Platz, als man denkt?', diff:2, exp:'bremsweg-jg9', video:'bremsweg-jg9.mp4', explanation:'Bis ein Auto steht, vergeht überraschend viel Weg – der Anhalteweg. In der Simulation wählst du ein Tempo (30, 50 oder 100 km/h) und löst „Gefahr!“ aus: Zuerst fährst du im Reaktionsweg noch mit vollem Tempo weiter (bis du reagierst), danach kommt der Bremsweg bis zum Stillstand. Anhalteweg = Reaktionsweg + Bremsweg. Entscheidend: Der Bremsweg wächst mit dem Quadrat der Geschwindigkeit (Faustformeln: Reaktionsweg = (v/10)·3, Bremsweg = (v/10)²) – doppeltes Tempo bedeutet also den vierfachen Bremsweg. Deshalb gilt vor Schulen oft Tempo 30.' },
          { name:'Warum fällt ein schwerer Stein nicht schneller als ein leichter?', diff:2, exp:'freier-fall-jg9', video:'freier-fall-jg9.mp4', explanation:'Viele vermuten: Schweres fällt schneller. In der Simulation fallen eine leichte (0,1 kg) und eine schwere Kugel gleichzeitig aus 20 m Höhe – ohne Luftwiderstand. Egal ob die schwere Kugel 1, 5 oder 10 kg wiegt: Beide bleiben auf gleicher Höhe und kommen gleichzeitig unten an. Die Fallzeit hängt also nicht von der Masse ab, sondern nur von der Höhe. Ohne Luftwiderstand fallen alle Körper mit derselben Fallbeschleunigung g ≈ 9,8 m/s² (freier Fall): s = ½·g·t² und v = g·t. Das zeigte auf dem Mond das berühmte Experiment mit Hammer und Feder.' },
          { name:'Warum fällt eine Feder langsamer als ein Stein – liegt es wirklich am Gewicht?', diff:2, exp:'luftwiderstand-jg9', video:'luftwiderstand-jg9.mp4', explanation:'In 9.2.9 fielen alle Körper gleich schnell – aber im Alltag schwebt eine Feder langsam zu Boden, während ein Stein herabsaust. In der Simulation lässt du beide gleichzeitig fallen und schaltest die Luft an oder aus. Mit Luft ist der Stein schnell unten, die Feder braucht viel länger. Im Vakuum dagegen fallen beide gleich schnell und kommen gleichzeitig an. Also bremst nicht das geringe Gewicht die Feder, sondern der Luftwiderstand – die Reibung der Luft, die von Form und Fläche abhängt (deshalb funktioniert auch ein Fallschirm).' },
          { name:'Warum bewegt sich nichts von allein schneller – wer oder was steckt dahinter?', diff:2, video:'traegheit.mp4', explanation:'Von allein ändert kein Körper seine Bewegung: Ein ruhender Körper bleibt in Ruhe, ein bewegter Körper gleitet mit gleichem Tempo geradeaus weiter – solange keine Kraft wirkt. Das nennt man Trägheit. Nur eine Kraft kann etwas schneller oder langsamer machen oder die Richtung ändern. Deshalb ruckelt man im Bus beim Bremsen nach vorn: Der Körper „will“ sich weiterbewegen. Das ist das Trägheitsprinzip (1. Newton’sches Gesetz). Das Lernvideo zeigt beide Zustände, die Rolle der Kraft und ein Alltagsbeispiel.' },
          { name:'Warum werde ich beim Anfahren in den Sitz gedrückt und beim Bremsen nach vorn geworfen?', diff:2, video:'traegheit-alltag.mp4', explanation:'Im Auto oder Bus spürt man die Trägheit direkt am eigenen Körper. Beim Anfahren will dein Körper zunächst in Ruhe bleiben – der Sitz nimmt dich mit, und es fühlt sich an, als würdest du nach hinten in den Sitz gedrückt. Beim Bremsen will dein Körper mit dem alten Tempo weiterfahren, deshalb wirst du nach vorn geworfen und der Sicherheitsgurt hält dich zurück. Dahinter steckt immer dasselbe Prinzip: Dein Körper behält seinen Bewegungszustand bei (Trägheit). Auch Kopfstütze und das „Nach-außen-Ziehen“ in der Kurve gehören dazu – deshalb ist Anschnallen so wichtig.' },
          { name:'Warum fühlt man sich im freien Fall schwerelos, obwohl die Erde weiter zieht?', diff:2, video:'schwerelosigkeit.mp4', explanation:'Wenn du auf einer Waage stehst, zieht dich die Erde nach unten und der Boden drückt mit gleicher Kraft zurück – die Waage zeigt dein volles Gewicht. Fällt dagegen eine ganze Kabine frei nach unten, fallen Waage und Körper gemeinsam: Niemand drückt mehr auf die Waage, sie zeigt 0 N, und alles scheint zu schweben. Wichtig ist, dass die Erdanziehung die ganze Zeit weiterwirkt – nur die Gegenkraft der Unterlage (die Auflagekraft) verschwindet beim Fallen. Genau das nennt man Schwerelosigkeit: freier Fall ohne Stützkraft. Man erlebt es im Freefall-Tower oder im Parabelflug.' },
          { name:'Warum schweben Astronauten in der Raumstation, obwohl sie ständig „fallen“?', diff:2, video:'orbit.mp4', explanation:'Oft heißt es, im All gebe es keine Schwerkraft – das stimmt nicht: In der Höhe der ISS (rund 400 km) wirkt die Erdanziehung noch fast so stark wie am Boden. Warum schweben die Astronauten dann? Newtons Kanonenkugel erklärt es: Schießt man eine Kugel waagerecht ab, fällt sie zu Boden; je schneller, desto weiter fliegt sie. Ist sie schnell genug, fällt sie zwar weiter zur Erde, verfehlt sie aber ständig – und umkreist sie. Genau das macht die ISS: Sie ist in einem ununterbrochenen freien Fall um die Erde. Weil die Station und alles an Bord gemeinsam fallen, drückt nichts auf eine Unterlage – deshalb herrscht Schwerelosigkeit. Dasselbe gilt für Satelliten und den Mond.' },
          { name:'Wie schafft es eine Rakete, sich im Weltall abzustoßen, wo doch nichts da ist?', diff:2, video:'rueckstoss.mp4', explanation:'Eine Rakete braucht nichts zum „Abstoßen“ – das erklärt der Luftballon: Lässt man ihn los, strömt die Luft hinten heraus und der Ballon fliegt nach vorn. Dahinter steckt das dritte newtonsche Gesetz: Zu jeder Kraft gehört eine gleich große Gegenkraft in die entgegengesetzte Richtung (actio = reactio). Der Ballon drückt die Luft nach hinten, die Luft drückt den Ballon nach vorn. Eine Rakete stößt heiße Gase nach unten aus, und die Gase stoßen die Rakete nach oben – ganz ohne Luft zum Abstoßen. Je mehr Masse ausgestoßen wird, desto größer der Schub. Dasselbe Rückstoßprinzip steckt in Silvesterraketen, Düsentriebwerken und sogar im Tintenfisch.' },
          { isChapter:true, name:'⚡ Energie, Arbeit & Leistung' },
          { name:'Was haben eine gespannte Feder, ein heißer Tee und ein rollender Ball gemeinsam?', diff:1, video:'energie.mp4', explanation:'Auf den ersten Blick haben eine gespannte Feder, ein heißer Tee und ein rollender Ball nichts gemeinsam – und doch steckt in allen dreien dasselbe: Jedes kann etwas bewirken. Die Feder kann eine Kugel wegschießen, der heiße Tee kann die Hände wärmen, der rollende Ball kann einen Turm umwerfen. Diesen „Vorrat“, die Fähigkeit etwas zu bewirken, nennt man Energie. Energie tritt in vielen Formen auf: Lageenergie (durch die Höhe), Bewegungsenergie, Spannenergie, Wärme, chemische Energie (in Nahrung und Benzin) und elektrische Energie. Egal in welcher Form – Energie wird immer in der Einheit Joule (J) gemessen. Gespeicherte Energie steckt überall im Alltag: in Batterie, Akku, Nahrung und Benzin. Das Lernvideo führt vom Phänomen zum Begriff und zeigt die wichtigsten Energieformen.' },
          { name:'Wann leiste ich in der Physik wirklich „Arbeit“ – und wann nicht?', diff:2, video:'arbeit.mp4', explanation:'Im Alltag ist Arbeit alles, was anstrengt – in der Physik gilt etwas anderes: Arbeit wird nur verrichtet, wenn eine Kraft einen Körper ein Stück weit bewegt. Hältst du eine schwere Kiste nur fest, strengt das zwar an, doch der Weg ist null – also ist die physikalische Arbeit ebenfalls null. Erst wenn du die Kiste schiebst oder hochhebst, leistest du Arbeit. Berechnet wird sie als Kraft mal Weg: W = F · s. Zwei Dinge machen die Arbeit größer – eine größere Kraft F und ein längerer Weg s. Die Kraft misst man in Newton (N), den Weg in Metern (m); zusammen ergibt das die Arbeit in Joule (J): 1 J = 1 N · 1 m. Beispiel: Schiebst du mit 10 N über 2 m, sind das 20 J. Merke: Heben und Schieben sind Arbeit, reines Halten ist keine.' },
          { name:'Warum kostet Treppensteigen mehr Kraft als Geradeausgehen?', diff:2, video:'hubarbeit.mp4', explanation:'Gehst du eben geradeaus, bleibt dein Körper auf gleicher Höhe – dabei wird keine Hubarbeit verrichtet. Steigst du dagegen eine Treppe hinauf, hebst du dein ganzes Gewicht Stufe für Stufe gegen die Schwerkraft nach oben, und genau das kostet zusätzliche Arbeit: die Hubarbeit. Berechnet wird sie als Masse mal Ortsfaktor mal Höhe: W = m · g · h. Dabei ist die Gewichtskraft F_G = m · g die Kraft, die du überwindest, und h die überwundene Höhe. Zwei Dinge machen die Hubarbeit größer: eine größere Masse und eine größere Höhe. Entscheidend ist nur die Höhe h – der waagerechte Weg zählt nicht mit (steile Treppe oder lange Rampe ergeben dieselbe Hubarbeit). Beispiel: Ein Kind mit m = 60 kg steigt h = 3 m hoch, mit g = 10 N/kg ergibt das W = 60 · 10 · 3 = 1800 J. Hubarbeit steckt überall, wo etwas gehoben wird: Aufzug, Bergwandern, Lasten ins Regal heben.' },
          { name:'Wo steckt Energie in einem Gegenstand, der ganz oben liegt?', diff:2, video:'lageenergie.mp4', explanation:'Ein Stein, der hoch oben liegt, sieht ganz ruhig aus – und doch steckt in ihm ein Energievorrat. Lässt man ihn fallen, trifft er mit Wucht auf und kann sogar einen Pfahl in den Boden treiben. Je höher er lag, desto größer die Wirkung. Diese durch die Höhe gespeicherte Energie nennt man Lageenergie (oder potenzielle Energie). Sie ist genau so groß wie die Hubarbeit, die man vorher hineingesteckt hat, und wird nach derselben Formel berechnet: E = m · g · h (Masse mal Ortsfaktor mal Höhe), Einheit Joule (J). Zwei Dinge vergrößern die Lageenergie: eine größere Höhe h und eine größere Masse m. Beispiel: Ein Stein mit m = 2 kg liegt h = 5 m hoch, mit g = 10 N/kg ergibt das E = 2 · 10 · 5 = 100 J. Lageenergie nutzen wir überall: im Stausee eines Wasserkraftwerks, beim Skispringer am Start und im hoch gelegenen Wasserturm.' },
          { name:'Warum kann ein rollender Ball etwas umwerfen – woher nimmt er die Kraft?', diff:2, video:'bewegungsenergie.mp4', explanation:'Eine langsam rollende Kugel stupst die Kegel nur leicht an, eine schnelle Kugel dagegen fegt alle weg. Der Grund: In jeder Bewegung steckt ein Energievorrat – die Bewegungsenergie (kinetische Energie). Sie hängt von zwei Größen ab: der Masse m und der Geschwindigkeit v. Berechnet wird sie als E = ½ · m · v² (ein halb mal Masse mal Geschwindigkeit im Quadrat), Einheit Joule (J). Wichtig ist das Quadrat bei der Geschwindigkeit: Doppelte Masse bedeutet doppelte Energie, doppeltes Tempo bedeutet aber vierfache Energie! Beispiel: Eine Kugel mit m = 2 kg und v = 3 m/s hat E = ½ · 2 · 3² = 9 J. Verdoppelt man nur das Tempo auf v = 6 m/s, ergibt sich E = ½ · 2 · 6² = 36 J – also viermal so viel Energie. Genau deshalb ist Geschwindigkeit im Straßenverkehr so gefährlich: Beim Auto-Aufprall wächst die Energie mit dem Quadrat des Tempos. Bewegungsenergie begegnet dir überall: beim Auto-Aufprall, beim Bowling und wenn ein Hammer einen Nagel eintreibt.' },
          { name:'Wohin verschwindet die Energie, wenn ein Ball einfach liegen bleibt?', diff:2, video:'reibungswaerme.mp4', explanation:'Ein rollender Ball wird von allein langsamer und bleibt schließlich liegen – dabei hatte er doch eben noch Bewegungsenergie. Wo ist sie hin? Die Antwort: Zwischen Ball und Boden wirkt Reibung, und diese Reibung wandelt die Bewegungsenergie Stück für Stück in Wärme um. Ball und Boden werden dabei ein winziges bisschen wärmer. Die Energie ist also nicht verschwunden – sie hat nur die Form gewechselt. Wie stark das passiert, hängt vom Untergrund ab: Auf einer glatten Fläche rollt der Ball weit und es entsteht wenig Wärme, auf einer rauen Fläche bleibt er schnell liegen und es wird mehr Bewegungsenergie in Wärme umgewandelt. Dahinter steckt eine wichtige Grundregel: Energie geht niemals verloren, sie wird nur von einer Form in eine andere umgewandelt (Energieerhaltung). Aus Bewegungsenergie wird hier Wärme, die Gesamtenergie bleibt gleich. Das erlebst du überall: Die Bremse am Fahrrad wird heiß, deine Hände werden warm, wenn du sie aneinander reibst, und ein Streichholz entzündet sich allein durch Reibung.' },
          { name:'Kann Energie einfach verschwinden – oder wandelt sie sich nur um?', diff:2, video:'energieerhaltung.mp4', explanation:'Ein Pendel schwingt hin und her: Ganz oben, an den Umkehrpunkten, steht es für einen kurzen Moment fast still, unten am tiefsten Punkt ist es am schnellsten. Dahinter steckt ein ständiger Tausch zwischen zwei Energieformen. Oben hat das Pendel viel Lageenergie (weil es hoch liegt), aber kaum Bewegungsenergie. Beim Herabschwingen wird die Lageenergie Stück für Stück in Bewegungsenergie umgewandelt – unten ist es umgekehrt: kaum Höhe, aber volles Tempo. Das Entscheidende: Zählt man Lageenergie und Bewegungsenergie zusammen, bleibt die Summe immer gleich. Wird die eine Form groß, wird die andere im gleichen Maß klein. Ohne Reibung geht dabei keine Energie verloren – sie wechselt nur die Form. Das ist der Energieerhaltungssatz: Energie kann weder erzeugt noch vernichtet, sondern nur von einer Form in eine andere umgewandelt werden. Genau das erlebst du auf der Schaukel, auf dem Trampolin und beim Flummi, der immer wieder hochspringt: Überall wird Höhe in Tempo umgewandelt und wieder zurück.' },
          { name:'Warum wird eine Achterbahn oben langsam und unten schnell?', diff:2, video:'achterbahn.mp4', explanation:'Auf der Achterbahn geht es am höchsten Punkt ganz gemächlich los und im Tal rast der Wagen mit voller Wucht durch. Der Grund ist eine Energieumwandlung entlang der Bahn. Oben hat der Wagen wegen seiner großen Höhe viel Lageenergie, aber wenig Bewegungsenergie. Beim Herabfahren wird die Lageenergie in Bewegungsenergie umgewandelt – deshalb wird der Wagen schneller und ist im tiefsten Tal am schnellsten. Beim Hochfahren läuft es rückwärts: Bewegungsenergie wird wieder zu Lageenergie, der Wagen wird langsamer. Entscheidend ist die Starthöhe: Startet der Wagen höher, hat er mehr Lageenergie zum Umwandeln und ist im Tal schneller. Deshalb ist der erste Berg einer Achterbahn immer der höchste – von dort holt sich der Wagen die Energie für die ganze Fahrt. Die Gesamtenergie bleibt dabei erhalten: Lageenergie und Bewegungsenergie tauschen sich ständig aus, ihre Summe bleibt gleich. Deshalb schafft der Wagen auch nie einen Berg, der höher ist als sein Start. Dasselbe Prinzip steckt im Skispringer auf der Anlaufspur und in der Halfpipe beim Skateboard: Höhe wird zu Tempo und Tempo wieder zu Höhe.' },
          { name:'Warum wird beim Bremsen und Reiben immer alles warm?', diff:2, video:'energieentwertung.mp4', explanation:'Eine Bremsscheibe wird heiß, ein Bohrer glüht fast, und geriebene Hände werden warm – überall, wo Reibung wirkt, entsteht Wärme. Der Grund ist immer derselbe: Reibung wandelt Bewegungsenergie in Wärme um. Die Energie geht dabei nicht verloren, sie ändert nur ihre Form. Doch jetzt kommt das Entscheidende: Vorher war die Energie hochwertig und gebündelt – eine schnelle, geordnete Bewegung. Als Wärme verteilt sie sich ungeordnet in Bremse, Luft und Umgebung. Diese verteilte Wärme kannst du kaum noch nutzen. Die Energiemenge bleibt gleich, aber ihre Nutzbarkeit sinkt. Das nennt man Energieentwertung: Die Energie ist nicht vernichtet, sondern nur in eine wenig nutzbare Form übergegangen – meist Wärme, die in die Umgebung entweicht. Deshalb wird bei jeder Reibung ein Teil der Energie für uns unbrauchbar. Das erklärt, warum die Bremse heiß wird, ein Streichholz sich durch Reibung entzündet und warum man mit Schmieröl versucht, Reibung und damit die Entwertung klein zu halten.' },
          { name:'Bekomme ich aus einer Maschine je so viel heraus, wie ich hineinstecke?', diff:2, video:'wirkungsgrad.mp4', explanation:'Fass eine eingeschaltete Glühlampe vorsichtig an – sie ist heiß. Ein großer Teil der zugeführten Energie wird gar nicht zu Licht. Man teilt die Energie deshalb in zwei Teile auf: Die zugeführte Energie fließt hinein, ein Teil davon wird zur nutzbaren Energie (beim Licht also die Helligkeit), der Rest geht als Verlust verloren, meist als Wärme. Zusammen ergeben nutzbare Energie und Verlust wieder die ganze zugeführte Energie. Wie gut eine Maschine ist, beschreibt der Wirkungsgrad. Er ist das Verhältnis von nutzbarer zu zugeführter Energie: Wirkungsgrad = nutzbare Energie ÷ zugeführte Energie. Meist gibt man ihn in Prozent an. Bei einer alten Glühlampe werden nur etwa 5 % zu Licht – der Wirkungsgrad ist also sehr klein. Eine LED macht es viel besser: Aus derselben zugeführten Energie holt sie deutlich mehr Licht heraus und verliert weniger als Wärme, ihr Wirkungsgrad ist viel höher. Bei gleicher Helligkeit braucht sie darum viel weniger Strom. Einen Wirkungsgrad gibt es überall: Die LED schlägt die Glühlampe, ein guter Motor holt mehr aus dem Kraftstoff, und ein Ladegerät wird warm, weil auch dort ein Teil der Energie verloren geht.' },
          { name:'Warum ist keine Maschine perfekt – wo geht die Energie verloren?', diff:2, video:'wirkungsgrad-verluste.mp4', explanation:'Handy, Laptop und Ladegerät werden im Betrieb warm – fast jedes Gerät gibt Abwärme ab. Diese Wärme ist Energie, die man eigentlich nicht wollte: Ein Teil der zugeführten Energie wird nicht zum Nutzen, sondern geht als Verlust weg. Wo steckt der Verlust? Meist in Reibung, die Wärme erzeugt, manchmal auch in Geräusch oder Abstrahlung. Von der zugeführten Energie wird nur ein Teil zur Nutzenergie, der Rest verlässt das Gerät als entwertete Wärme. Deshalb erreicht kein Gerät 100 %. Ein Rechenbeispiel: Ein Motor bekommt 1000 J zugeführt und liefert davon 250 J als nutzbare Bewegung. Der Wirkungsgrad ist nutzbar ÷ zugeführt = 250 J ÷ 1000 J = 0,25 = 25 %. Die restlichen 75 % gehen als Wärme verloren. Vergleicht man Geräte, zeigen sich große Unterschiede: Die Glühlampe schafft nur etwa 5 %, ein Auto-Motor rund 25 %, eine LED etwa 40 %, ein Elektromotor über 90 % – aber keines erreicht 100 %. Genau das zeigt auch das Energielabel von A bis G: Es verrät, wie sparsam ein Gerät mit Energie umgeht, also wie hoch sein Wirkungsgrad ist.' },
          { name:'Warum ist schnell arbeiten anstrengender als langsam – obwohl die Arbeit gleich ist?', diff:2, video:'leistung.mp4', explanation:'Zwei Personen tragen dieselbe Kiste die gleiche Treppe hinauf – die eine rennt, die andere geht gemütlich. Beide heben dieselbe Kiste auf dieselbe Höhe, verrichten also genau die gleiche Arbeit (W = Kraft · Weg). Trotzdem kommt die rennende Person außer Atem. Der Unterschied ist die Zeit: Sie schafft die gleiche Arbeit in viel kürzerer Zeit und muss die Energie schneller umsetzen – und genau das strengt an. Nicht die Arbeit ist größer, sondern die Arbeit pro Zeit. Diese Arbeit pro Zeit nennt man Leistung: P = W ÷ t (Leistung = Arbeit geteilt durch Zeit). Beispiel: 600 J Arbeit in 3 s ergeben 600 ÷ 3 = 200 W; dieselben 600 J in 6 s sind nur 100 W. Gleiche Arbeit, halbe Zeit, doppelte Leistung. Die Einheit der Leistung ist das Watt: 1 W = 1 Joule pro Sekunde. Große Leistungen gibt man in Kilowatt an (1 kW = 1000 W). Deshalb ist Treppenrennen anstrengender als gemütliches Steigen, und deshalb steht bei Motoren die Leistung dabei: Sie sagt, wie schnell ein Motor Energie in Bewegung umsetzen kann.' },
          { name:'Was bedeutet eigentlich „100 PS" oder „2000 Watt"?', diff:2, video:'leistung-einheiten.mp4', explanation:'Auf dem Föhn steht 2000 Watt, das Auto hat 100 PS, die Bohrmaschine 600 Watt – fast jedes Gerät trägt eine Leistungsangabe auf dem Typenschild. Alle diese Angaben beschreiben dasselbe: die Leistung, also wie schnell das Gerät Energie umsetzt. Denn Leistung ist Energie pro Zeit: 2000 Watt heißt, dass jede Sekunde 2000 Joule umgesetzt werden. Je größer die Zahl, desto mehr Energie fließt pro Sekunde und desto kräftiger arbeitet das Gerät. Die Einheiten hängen einfach zusammen: 1000 Watt sind 1 Kilowatt (kW). PS ist eine ältere Einheit, die Pferdestärke: 1 PS sind ungefähr 0,74 kW. 100 PS sind also rund 74 kW oder 74000 Watt. So kann man alles vergleichen: Eine Bohrmaschine hat 600 W, ein Föhn oder Herd 2000 W, ein Auto mit 100 PS dagegen rund 74000 W – ein Vielfaches. Deshalb steht auf jedem Typenschild eine Leistungsangabe, deshalb vergleicht man Motoren in PS oder Kilowatt, und deshalb muss eine Sicherung zur Leistung der angeschlossenen Geräte passen.' },
          { name:'Wenn Energie nie verloren geht – warum müssen wir dann Energie sparen?', diff:2, video:'energie-entwerten.mp4', explanation:'Du hast gelernt: Energie geht nie verloren, sie wandelt sich nur um. Warum sollen wir dann überhaupt Energie sparen? Im Alltag sagen wir zwar „der Akku ist leer" oder „der Tank ist leer", es fühlt sich an, als wäre die Energie einfach weg. Aber nach dem Energieerhaltungssatz ist die Energiemenge gleich geblieben: Aus dem Strom im Akku wurde Licht, Bewegung und Wärme – kein einziges Joule ist verschwunden, die Energie hat nur ihre Form gewechselt und sich in der Umgebung verteilt. Der Haken ist die Nutzbarkeit. Hochwertige Energie wie Strom oder Benzin ist gebündelt und vielseitig einsetzbar. Bei jeder Umwandlung entsteht Wärme, die sich in der Umgebung verteilt. Diese entwertete Umgebungswärme ist zwar noch da, aber so dünn verteilt, dass wir sie nicht mehr nutzen können. Energie wird also nicht verbraucht, sondern entwertet. Genau deshalb sparen wir Energie: Nicht die Menge wird knapp, sondern die hochwertige, nutzbare Energie. Unsere Vorräte an Strom, Benzin und Brennstoffen sind begrenzt, und einmal entwertete Wärme bekommen wir nicht zurück. Sparen heißt: die wertvolle, nutzbare Energie klug einsetzen – und genau darum geht es im nächsten Kapitel zur Energieversorgung.' },
          { isChapter:true, name:'🏭 Kraftwerke, Energieversorgung & Klimaschutz' },
          { name:'Woher kommt eigentlich der Strom, wenn ich einen Schalter drücke?', diff:2, video:'energiekette.mp4', explanation:'Du drückst einen Schalter und das Licht geht an – aber woher kommt der Strom eigentlich? Klar, aus der Steckdose. Doch die Steckdose ist nicht der Anfang: Hinter ihr steckt ein langer Weg, den die Energie zurücklegt. Diesen Weg nennt man Energiekette. Sie beginnt bei einer Energiequelle (zum Beispiel Kohle, Wind oder Sonne). Im Kraftwerk wird daraus elektrische Energie. Über das Stromnetz und die Leitungen gelangt sie bis zu deiner Steckdose und von dort in die Lampe: Quelle → Kraftwerk → Stromnetz → Steckdose → Lampe. Wichtig ist, dass die Energie in dieser Kette nur umgewandelt und transportiert, nicht erzeugt wird. Aus der Energie der Quelle wird elektrische Energie, aus elektrischer Energie am Ende Licht. Ein Kraftwerk erzeugt also keine Energie aus dem Nichts – es wandelt vorhandene Energie in nutzbaren Strom um. Der Anfang der Kette kann verschieden sein (Kohle, Gas, Wind, Sonne, Wasser), doch der Rest bleibt gleich. Das merkst du besonders bei einem Stromausfall: Dann ist die Kette unterbrochen. Und wenn du das nächste Mal eine Steckdose siehst, weißt du: Dahinter beginnt ein weiter Weg bis zum Kraftwerk.' },
          { name:'Wie wird aus Bewegung oder Wärme nutzbarer Strom?', diff:2, video:'generator.mp4', explanation:'Am Fahrrad gibt es einen kleinen Dynamo: Sobald sich das Rad dreht, leuchtet die Lampe – ganz ohne Batterie. Steht das Rad still, bleibt die Lampe dunkel; je schneller du fährst, desto heller wird das Licht. Die Bewegung hat also mit dem Strom zu tun. Das Bauteil dahinter heißt Generator. In ihm dreht sich ein Magnet an einer Spule aus Draht vorbei, und durch diese Bewegung entsteht in der Spule elektrischer Strom. Ein Generator wandelt somit Bewegungsenergie in elektrische Energie um – genau umgekehrt wie ein Elektromotor. Wovon hängt der Strom ab? Von der Drehgeschwindigkeit: Dreht sich der Magnet langsam, entsteht wenig Strom und die Lampe glimmt nur; dreht er sich schnell, entsteht mehr Strom und die Lampe leuchtet hell. Dasselbe Prinzip steckt auch in großen Anlagen: Beim Windrad drehen die Flügel den Generator, im Kraftwerk treibt heißer Wasserdampf eine Turbine an, die den Generator dreht. Ob Fahrrad, Windrad oder Kraftwerk – überall wandelt ein Generator die Drehbewegung in Strom um. (Die genauen Details der Induktion kommen erst in Klasse 10.)' },
          { name:'Warum haben so viele Kraftwerke dasselbe Grundprinzip – egal welcher Brennstoff?', diff:2, video:'waermekraftwerk.mp4', explanation:'Kohle-, Gas- und Kernkraftwerk sehen von außen verschieden aus, funktionieren im Inneren aber nach demselben Grundprinzip. Schaut man hinein, findet man fast immer dieselben Bauteile: einen Kessel, eine Turbine und einen Generator. So läuft es ab: Im Kessel wird Wärme erzeugt und Wasser zu heißem Dampf. Der Dampf strömt mit hohem Druck auf eine Turbine und bringt sie zum Drehen. Die Turbine dreht den Generator, und der wandelt die Bewegung in elektrischen Strom um. Wärme wird also zu Bewegung, Bewegung zu Strom. Der einzige Unterschied zwischen den Kraftwerken ist, wie die Wärme entsteht: Kohle, Gas und Biomasse werden verbrannt, im Kernkraftwerk liefert die Kernspaltung die Wärme. Ab dem heißen Dampf ist die Kette aber immer gleich: Dampf → Turbine → Generator → Strom. Perfekt ist das nicht: Ein großer Teil der Wärme wird nicht zu Strom, sondern entweicht als Abwärme, oft über die großen Kühltürme. Deshalb hat ein Wärmekraftwerk nur einen Wirkungsgrad von etwa 40 %. Genau deshalb funktionieren Kohle-, Gas-, Biomasse- und Kernkraftwerke im Kern gleich – sie unterscheiden sich nur darin, woher die Wärme kommt.' },
          { name:'Was passiert mit unserem Brennstoff, wenn er einmal verbrannt ist?', diff:2, video:'fossile-energie.mp4', explanation:'Kohle, Öl und Gas liefern viel Energie – aber was passiert mit dem Brennstoff, wenn er verbrannt ist? Beim Verbrennen wird der Kohlehaufen immer kleiner, bis er verschwunden ist; übrig bleiben nur Asche und Abgase, die in die Luft aufsteigen. Der Brennstoff selbst ist unwiederbringlich verbraucht. Das ist das Problem fossiler Energieträger: Es gibt nur einen begrenzten Vorrat. Kohle, Öl und Gas sind über Millionen Jahre entstanden, und was wir heute verbrennen, wächst nicht nach – je mehr wir nutzen, desto kleiner wird der Vorrat, bis er irgendwann erschöpft ist. Beim Verbrennen entsteht außerdem ein wichtiges Abgas: Kohlenstoffdioxid, kurz CO2. Der Kohlenstoff aus dem Brennstoff verbindet sich mit dem Sauerstoff der Luft, und dieses CO2 steigt in die Atmosphäre – mit Folgen für unser Klima. Anders die regenerativen Quellen wie Sonne und Wind: Sie erneuern sich laufend und stoßen im Betrieb kaum CO2 aus. Genau darum geht es beim Umstieg auf erneuerbare Energien. Deshalb sprechen wir über knapper werdende Öl- und Gasreserven, über den Benzinverbrauch von Autos und über die CO2-Bilanz von allem, was wir tun.' },
          { name:'Wie kann man Strom gewinnen, ohne etwas zu verbrennen?', diff:2, video:'regenerative-energie.mp4', explanation:'Eine Solarzelle liefert Strom, sobald Licht auf sie fällt, ein Windrad dreht sich im Wind und erzeugt Strom – aber wie geht das ohne Verbrennen? Beobachte: Scheint die Sonne auf die Solarzelle, fließt Strom und die Lampe leuchtet. Weht der Wind, drehen sich die Flügel des Windrads. Fließt Wasser, treibt es ein Wasserrad an. In allen Fällen entsteht Strom – ganz ohne Feuer und ohne Abgase. Der Trick: Sonne, Wind und Wasser liefern die Energie sozusagen frei Haus. Die Sonne strahlt, der Wind weht, das Wasser fließt, und wir müssen nichts verbrennen, um diese Energie zu nutzen – deshalb entsteht dabei auch kein CO2. Wovon es abhängt? Von der Quelle selbst: Ohne Licht liefert die Solarzelle nichts, bei Sonnenschein viel; ohne Wind steht das Windrad still, bei kräftigem Wind dreht es schnell. Das ist der große Unterschied zu Kohle und Öl: Fossile Energie wird verbraucht und ist irgendwann weg, regenerative Quellen dagegen erneuern sich immer wieder – morgen scheint die Sonne erneut, der Wind weht weiter, das Wasser fließt weiter. Deshalb heißen sie erneuerbare oder regenerative Energien. Du siehst sie als Solardächer auf Häusern, Windparks in der Landschaft und Wasserkraftwerke an Flüssen und Staudämmen.' },
          { name:'Wie holt man Energie aus Sonne, Wind und Wasser?', diff:2, video:'sonne-wind-wasser.mp4', explanation:'Sonne, Wind und Wasser liefern erneuerbare Energie – aber jede Anlage arbeitet nach einem eigenen Wirkprinzip. Die Photovoltaik nutzt die Sonne: In einer Solarzelle wird das Sonnenlicht direkt in elektrischen Strom umgewandelt, ganz ohne bewegliche Teile und ohne Generator. Je stärker das Licht, desto mehr Strom. Die Windkraft nutzt den Wind: Er trifft auf die großen Flügel und bringt sie zum Drehen, diese Drehung treibt einen Generator an, der Strom erzeugt. Je kräftiger der Wind, desto mehr Strom. Die Wasserkraft nutzt fallendes oder strömendes Wasser: Es stürzt in die Tiefe und treibt eine Turbine an, die einen Generator dreht. Je größer die Fallhöhe, desto mehr Strom. Vergleicht man die drei, fällt ein Unterschied auf: Bei der Photovoltaik wird Licht direkt in elektrische Energie umgewandelt; bei Wind und Wasser entsteht dagegen zuerst eine Drehbewegung, die ein Generator in Strom verwandelt. Zwei Wege, ein Ziel: sauberer Strom. Deshalb baut man Solaranlagen dorthin, wo viel Sonne scheint, Windräder an windige Orte und Wasserkraftwerke an Flüsse mit starkem Gefälle – der richtige Standort entscheidet über den Ertrag.' },
          { name:'Warum reicht es nicht, einfach nur viele Windräder aufzustellen?', diff:2, video:'volatilitaet.mp4', explanation:'Man könnte meinen: Bauen wir einfach ganz viele Windräder und Solaranlagen, dann ist das Problem gelöst. So einfach ist es aber nicht. Das Problem: Sonne und Wind liefern nicht immer gleich viel. Nachts scheint keine Sonne, bei Windstille steht das Windrad still – die Erzeugung schwankt ständig. Schaut man sich einen Tag an, ist die Solarerzeugung mittags am höchsten und nachts null. Der Strombedarf dagegen ist ziemlich gleichmäßig und hat abends sogar eine Spitze, wenn alle zu Hause sind. Erzeugung und Bedarf passen zeitlich also oft nicht zusammen. Dadurch entstehen zwei Situationen: Mittags liefert die Sonne mehr, als gerade gebraucht wird (ein Überschuss); abends und nachts liefert sie zu wenig (eine Lücke). Der Strom kommt oft zur falschen Zeit. Deshalb reichen viele Windräder allein nicht – man braucht einen Ausgleich: Speicher, die den Überschuss aufbewahren und ihn abgeben, wenn zu wenig erzeugt wird. So wird aus schwankender Erzeugung eine verlässliche Versorgung. Das erklärt die Mittags-Solarspitze (zeitweise zu viel Strom) und die gefürchtete Dunkelflaute, wenn tagelang wenig Wind und wenig Sonne zusammenkommen.' },
          { name:'Wie kann man Energie aufheben, bis man sie wirklich braucht?', diff:2, video:'energiespeicher.mp4', explanation:'Manchmal gibt es zu viel Strom, manchmal zu wenig – wäre es nicht praktisch, den Überschuss aufzuheben, bis man ihn braucht? Genau das machen Energiespeicher: Gibt es einen Überschuss, wird er gespeichert; fehlt später Strom, gibt der Speicher ihn wieder ab. So verschiebt man Energie von der Zeit, in der zu viel da ist, in die Zeit, in der zu wenig da ist. Ein gutes Beispiel ist das Pumpspeicherwerk: Bei Überschuss wird Wasser mit dem Strom nach oben in einen hoch gelegenen See gepumpt, wo es als Lageenergie wartet; wird Strom gebraucht, lässt man das Wasser wieder nach unten stürzen, wo es eine Turbine und einen Generator antreibt. Es gibt verschiedene Speicher: Der Akku speichert Energie chemisch, das Pumpspeicherwerk als Lageenergie des Wassers, und beim Wasserstoff wird mit überschüssigem Strom Wasser aufgespalten und das Gas gespeichert. Ganz umsonst ist das Speichern aber nicht: Bei jedem Laden und Entladen geht ein Teil der Energie verloren, meist als Wärme – man bekommt weniger heraus, als man hineingesteckt hat. Das beschreibt der Speicher-Wirkungsgrad, der immer kleiner als 100 % ist. Deshalb gibt es den Hausakku zur Solaranlage, große Pumpspeicherwerke in den Bergen und die Idee, das E-Auto als Speicher fürs Stromnetz zu nutzen.' },
          { name:'Warum verändert das Verbrennen von Kohle, Öl und Gas das Klima der ganzen Erde?', diff:2, video:'treibhauseffekt.mp4', explanation:'Seit wir viel Kohle, Öl und Gas verbrennen, steigt der CO2-Gehalt der Luft – und mit ihm die Temperaturen auf der Erde. Wie kann ein unsichtbares Gas das Klima verändern? Sieh dir den Weg der Energie an: Die Sonne schickt Licht zur Erde, der Boden nimmt es auf und erwärmt sich, und diese Wärme strahlt die Erde wieder ab, zurück Richtung Weltall. Solange alles im Gleichgewicht ist, bleibt es angenehm warm. Jetzt kommt das CO2 ins Spiel: Treibhausgase wie CO2 lassen das Sonnenlicht ungehindert zur Erde durch, die Wärmestrahlung von der Erde halten sie aber teilweise zurück und werfen sie zur Erde zurück. Wärme wird eingefangen – wie unter dem Glasdach eines Gewächshauses. Daher der Name Treibhauseffekt. Je mehr Treibhausgas in der Luft ist, desto mehr Wärmestrahlung wird zurückgehalten: Weniger Wärme entweicht ins All, mehr bleibt bei uns, und die Erde wird wärmer. Genau das geschieht, wenn wir immer mehr fossile Brennstoffe verbrennen. Bei wenig Treibhausgas entweicht viel Wärme und es bleibt kühl, bei viel Treibhausgas steigt das Thermometer. Deshalb zählt jedes bisschen CO2 – aus dem Auspuff der Autos, aus der Heizung und aus allem, was wir verbrennen. Das ist unser CO2-Fußabdruck.' },
          { name:'Warum ist ein bisschen Treibhauseffekt lebenswichtig – und zu viel gefährlich?', diff:2, video:'natuerlicher-treibhauseffekt.mp4', explanation:'Der Treibhauseffekt klingt erstmal schlecht – aber ohne ihn gäbe es uns gar nicht. Stell dir die Erde ganz ohne Treibhausgase vor: Das Sonnenlicht wärmt zwar tagsüber, doch die ganze Wärme strahlt sofort wieder ins All ab. Es bliebe im Mittel etwa −18 °C kalt, überall Eis, kein flüssiges Wasser, kein Leben wie wir es kennen. Zum Glück hat unsere Atmosphäre von Natur aus Treibhausgase. Sie halten einen Teil der Wärme zurück und heben die Durchschnittstemperatur auf angenehme +15 °C – dieser natürliche Treibhauseffekt macht die Erde erst bewohnbar. Jetzt das Problem: Durch das Verbrennen von Kohle, Öl und Gas bringen wir Menschen zusätzliches CO2 in die Luft und verstärken den natürlichen Effekt. Es wird noch mehr Wärme zurückgehalten, und die Erde erwärmt sich weiter – diesen zusätzlichen Teil nennt man den menschengemachten (anthropogenen) Treibhauseffekt. Im Vergleich: ohne Atmosphäre eisige −18 °C, mit natürlichem Effekt angenehme +15 °C, mit dem verstärkten Effekt klettert die Temperatur immer weiter nach oben. Ein bisschen Treibhauseffekt ist also lebenswichtig, zu viel wird gefährlich, weil jedes zusätzliche Grad das Klima aus dem Gleichgewicht bringt.' },
          { name:'Woran erkennt man, dass sich das Klima wirklich ändert?', diff:2, video:'wetter-klima.mp4', explanation:'Ein kalter Winter oder ein verregneter Sommer – heißt das, es gibt gar keine Erderwärmung? Das Problem: Ein einzelner Tag oder ein einzelnes Jahr sagt wenig aus. Mal ist es wärmer, mal kälter – das ist Wetter, und Wetter schwankt ständig. Aus einem kalten Tag kann man nichts über das Klima schließen. Deshalb muss man Wetter und Klima unterscheiden: Wetter ist der Zustand der Luft gerade jetzt oder heute (kurzfristig und wechselhaft), Klima ist das Wetter über einen langen Zeitraum gemittelt, meist über 30 Jahre. Schaut man sich die Temperaturen über viele Jahrzehnte an, zappelt die Kurve von Jahr zu Jahr auf und ab – das ist die Schwankung des Wetters. Legt man aber eine mittlere Linie hindurch, zeigt sie klar nach oben, und diese langfristige Linie ist das Klima. Das ist der entscheidende Punkt: Die kurzfristigen Ausschläge nach oben und unten sind Wetter, der langfristige Anstieg über Jahrzehnte ist der Klimatrend – und der zeigt eine deutliche Erwärmung. Einzelne kalte Jahre ändern daran nichts. Man sieht die Veränderung an schmelzenden Gletschern, an immer häufigeren Hitzesommern und an Klimadiagrammen, die über Jahrzehnte nach oben zeigen.' },
          { name:'Wie können wir Energie nutzen, ohne die Zukunft zu belasten?', diff:2, video:'nachhaltigkeit.mp4', explanation:'Wir brauchen Energie für Licht, Wärme und alle Geräte – aber wie nutzen wir sie, ohne die Zukunft und das Klima zu belasten? Der Schlüssel heißt Nachhaltigkeit. Zwei Haushalte mit gleichem Komfort (beide warm und hell) können sich stark unterscheiden: Der eine verbraucht viel Energie und stößt viel CO2 aus, der andere kommt mit viel weniger aus. Gleicher Komfort ist also mit sehr verschiedenem Verbrauch möglich. Wie schafft man das? Mit gezielten Maßnahmen: Eine gute Dämmung hält die Wärme im Haus, LED-Lampen brauchen viel weniger Strom als alte Glühlampen, eine Wärmepumpe heizt effizient und Ökostrom liefert Energie ohne CO2. Schaltet man diese Maßnahmen zu, sinken Verbrauch und CO2 deutlich – bei gleichem Komfort fällt der CO2-Ausstoß fast auf null. Dahinter steckt ein einfaches Rezept aus drei Teilen: erstens Energie sparen (unnötigen Verbrauch vermeiden), zweitens effizient sein (mit derselben Energie mehr erreichen), drittens auf regenerative Quellen setzen. Zusammen ergibt das eine nachhaltige Energieversorgung. Und das fängt bei dir an: Licht ausschalten, Geräte nicht im Standby lassen, kurz lüften statt Fenster kippen – auch dein Haushalt und deine Schule können so Energie und CO2 sparen.' },
          { name:'Wie könnte die Energieversorgung meiner Stadt in 30 Jahren aussehen?', diff:2, video:'energiemix.mp4', explanation:'Zum Abschluss ein Blick in die Zukunft: Wie könnte die Energieversorgung deiner Stadt in 30 Jahren aussehen? Dafür musst du alles zusammenbringen, was du über Energie gelernt hast. So sieht der Strommix heute oft aus: Ein großer Teil kommt noch aus Kohle und Gas, dazu etwas Kernkraft und ein wachsender Anteil aus Sonne, Wind und Wasser. Weil noch viel verbrannt wird, ist der CO2-Ausstoß hoch. In den nächsten Jahrzehnten verschieben sich die Anteile: Kohle und Gas werden weniger, Sonne und Wind werden zur wichtigsten Quelle, und Speicher gleichen den schwankenden Strom aus. Mit jedem Schritt Richtung erneuerbar sinkt der CO2-Ausstoß. Wenn du den Mix selbst planst, musst du zwei Dinge im Blick behalten: Ist der Bedarf jederzeit gedeckt? Und wie hoch ist der CO2-Ausstoß? Ein guter Mix deckt den Bedarf sicher und stößt möglichst wenig CO2 aus. Dabei gibt es einen Zielkonflikt: Die Versorgung muss immer sicher sein, auch bei Dunkelflaute, und gleichzeitig soll sie das Klima schützen. Versorgungssicherheit und Klimaschutz gemeinsam zu denken, ist die große Aufgabe. Damit schließt sich der Kreis von Jahrgang 9 – von Kräften über Bewegung und Energie bis zur Frage, wie wir die Energie der Zukunft klug und klimafreundlich nutzen. Jetzt kannst du selbst bewerten und mitentscheiden.' },
        ],
        exercises:[
        ]
      },
    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          ...
          { name:'Warum zeigt eine Kompassnadel immer nach Norden?', diff:2, video:'erdmagnetfeld.mp4', explanation:'Die Erde ist ein riesiger Magnet: In ihrem Inneren wirkt es wie ein gewaltiger Stabmagnet, dessen Feldlinien weit in den Raum reichen. Eine frei bewegliche Kompassnadel richtet sich in diesem Feld aus und zeigt nach Norden. Wichtig: Der magnetische Pol liegt nicht genau am geografischen Nordpol, sondern etwa 11° daneben – diese Abweichung heißt Missweisung. Genau genommen liegt nahe dem geografischen Nordpol ein magnetischer Südpol, deshalb wird die Nordspitze der Nadel dorthin gezogen. Eisen oder Magnete in der Nähe stören den Kompass, weil ihr Feld stärker ist als das schwache Erdfeld.' },
          { name:'Kann elektrischer Strom eine Kompassnadel bewegen?', diff:2, video:'oersted.mp4', explanation:'Der Oersted-Versuch (1820): Über einer Kompassnadel liegt ein Draht. Ohne Strom zeigt die Nadel nach Norden. Schließt man den Stromkreis, springt sie sofort zur Seite und stellt sich quer zum Draht. Der fließende Strom erzeugt also selbst ein Magnetfeld – es bildet Kreise rund um den Draht. Kehrt man die Stromrichtung um, dreht sich die Feldrichtung um und die Nadel kippt zur anderen Seite. Je größer die Stromstärke, desto stärker das Feld. Das ist die Entdeckung des Elektromagnetismus und die Grundlage von Elektromagnet, Motor und Lautsprecher.' },
          { name:'Wie baue ich einen Magneten zum An- und Ausschalten?', diff:2, video:'elektromagnet-jg10.mp4', explanation:'Eine Spule aus Draht mit Eisenkern wird zum Magneten, sobald Strom fließt – und verliert den Magnetismus, sobald man ausschaltet (schaltbarer Magnet). Jede Windung erzeugt ein kleines Feld; viele Windungen hintereinander addieren sich zu einem starken Gesamtfeld mit Nord- und Südpol wie beim Stabmagneten. Ein Eisenkern bündelt das Feld und verstärkt die Tragkraft sprunghaft. Kehrt man die Stromrichtung um, tauschen Nord- und Südpol die Plätze. Der Elektromagnet ist also an-/ausschaltbar, verstärkbar und umpolbar.' },
          { name:'Was macht einen Elektromagneten stärker?', diff:2, video:'elektromagnet-staerke.mp4', explanation:'Drei Stellschrauben bestimmen die Stärke: (1) mehr Windungen, (2) mehr Stromstärke, (3) ein Eisenkern. Die Tragkraft wächst mit der Windungszahl mal der Stromstärke (N · I). Der Eisenkern bringt meist den größten Effekt, weil er das Feld bündelt – oft ein Vielfaches. In der Praxis kombiniert man die Faktoren: Ein Schrottkran nutzt viele Windungen und viel Strom, ein MRT riesige gekühlte Spulen, eine Magnetschwebebahn besonders starke Elektromagnete.' },
          { name:'Wo stecken schaltbare Magnete im Alltag?', diff:2, video:'elektromagnet-anwendungen.mp4', explanation:'Weil man ihn schalten, verstärken und umpolen kann, steckt der Elektromagnet in vielen Geräten. Schrottkran: Strom an → hält das Auto, Strom aus → lässt es fallen. Relais: Ein schwacher Steuerstrom macht einen kleinen Elektromagneten an, der einen Hebel anzieht und damit einen viel stärkeren Lastkreis schließt. Klingel: Der Klöppel unterbricht beim Anschlagen selbst den Kontakt → der Magnet lässt los, eine Feder zieht zurück, der Kontakt schließt wieder → er rasselt. Lautsprecher: Wechselstrom in einer Spule am Dauermagneten lässt die Membran zittern und erzeugt Schall. Auch Türöffner, Festplatte und Anlasser nutzen Elektromagnete.' },
          { name:'Warum bewegt sich ein Draht im Magnetfeld?', diff:2, video:'lorentzkraft.mp4', explanation:'Liegt ein stromdurchflossener Draht im Magnetfeld, wirkt auf ihn eine Kraft (Lorentzkraft) – er wird zur Seite geschoben. Ursache: Das Magnetfeld und das ringförmige Feld des Stroms überlagern sich. Auf einer Seite verstärken sie sich (Feldlinien dicht), auf der anderen schwächen sie sich (dünn) – wie bei einem Katapult wird der Draht zur schwachen Seite gedrückt. Die Kraft steht immer senkrecht auf Strom und Feld. Kehrt man die Stromrichtung oder die Pole um, kehrt sich die Kraft um. Läuft der Strom parallel zum Feld, wirkt keine Kraft.' },
          { name:'Wie sage ich die Richtung der Kraft vorher?', diff:2, video:'drei-finger-regel.mp4', explanation:'Mit der Drei-Finger-Regel der rechten Hand: Spreize Daumen, Zeigefinger und Mittelfinger rechtwinklig ab. Daumen = Strom, Zeigefinger = Magnetfeld (N→S), Mittelfinger = Kraft. Merkhilfe U-V-W: Ursache (Strom) – Vermittlung (Feld) – Wirkung (Kraft). Man stellt Daumen und Zeigefinger nach Strom und Feld ein, dann zeigt der Mittelfinger die Kraftrichtung. Kehrt sich der Strom um, dreht sich auch die Kraft um. Damit bestimmt man z. B. die Drehrichtung eines Motors.' },
          { name:'Wie wird aus der Kraft eine Drehbewegung?', diff:2, video:'elektromotor.mp4', explanation:'Im Elektromotor liegt eine drehbare Spule zwischen den Polen eines Magneten. In den beiden Seiten der Spule fließt der Strom entgegengesetzt, deshalb wirkt die Lorentzkraft auf die eine Seite nach oben, auf die andere nach unten. Dieses Kräftepaar (Drehmoment) dreht die Spule – elektrische Energie wird in Bewegungsenergie umgewandelt. Problem: Steht die Spule senkrecht, wirken die Kräfte längs der Spule und drehen nicht weiter (Totpunkt). Die Lösung ist der Kommutator.' },
          { name:'Warum dreht der Motor immer weiter?', diff:2, video:'kommutator.mp4', explanation:'Bliebe die Stromrichtung fest, würde die Spule an der Senkrechten zurückgedrückt und nur hin und her pendeln. Der Kommutator (Polwender) ist ein geteilter Ring am Ende der Spule; zwei Schleifkontakte (Bürsten) liefern den Strom. Der Ring dreht sich mit und lässt bei jeder halben Umdrehung die Kontakte wechseln – dadurch kehrt sich der Strom in der Spule genau im richtigen Moment um. So treibt die Kraft die Spule immer in dieselbe Richtung weiter: Der Motor läuft rund (Gleichstrommotor).' },
          { name:'Was macht einen Motor kräftiger und schneller?', diff:2, video:'motor-optimieren.mp4', explanation:'Vier Stellschrauben: (1) mehr Stromstärke → größere Kräfte, schnellere Drehung; (2) mehr Windungen → mehr Drehmoment; (3) stärkeres Magnetfeld → größere Kräfte auf die Spule; (4) ein Eisenkern (Anker) bündelt das Feld, und mehrere versetzte Spulen sorgen für gleichmäßigen Lauf ohne Totpunkt. Echte Motoren kombinieren diese Faktoren je nach Aufgabe – vom Spielzeugmotor bis zum kräftigen Antrieb eines Elektroautos.' },
          { name:'Kann ein bewegter Magnet Strom erzeugen – ohne Batterie?', diff:2, video:'induktion.mp4', explanation:'Elektromagnetische Induktion (Faraday 1831): Bewegt man einen Magneten in eine Spule, schlägt das angeschlossene Messgerät aus – es fließt Strom, ganz ohne Batterie. Schiebt man den Magneten hinein, fließt der Strom in die eine Richtung, zieht man ihn heraus, in die andere. Der Kernpunkt: Liegt der Magnet still in der Spule, wird nichts induziert – nur die Änderung des Magnetfeldes erzeugt eine Spannung. Je schneller die Änderung, desto größer die Spannung. So arbeiten Fahrraddynamo, kabelloses Laden und der Generator.' },
          { name:'Wovon hängt die induzierte Spannung ab?', diff:2, video:'induktionsspannung.mp4', explanation:'Die Höhe der induzierten Spannung hängt von drei Größen ab: (1) Geschwindigkeit der Bewegung – schneller bewegen bedeutet eine raschere Feldänderung und mehr Spannung; (2) Windungszahl der Spule – mehr Windungen erzeugen bei gleicher Bewegung mehr Spannung; (3) Stärke des Magneten – ein stärkeres Feld induziert mehr Spannung. Deshalb haben Dynamo, Gitarren-Tonabnehmer und Kraftwerksgeneratoren Spulen mit vielen Windungen und starke Magnete.' },
          { name:'Warum bremst der Magnet beim Bewegen?', diff:2, video:'lenzsche-regel.mp4', explanation:'Lenzsche Regel: Der induzierte Strom wirkt immer der Änderung entgegen, die ihn erzeugt hat. Nähert sich der Magnet der Spule, baut diese an der nahen Seite einen gleichen Pol auf und stößt ihn ab; entfernt man ihn, zieht sie ihn zurück. Man spürt das als Widerstand. Der Grund ist die Energieerhaltung: Die Arbeit, die man gegen den Widerstand leistet, wird in elektrische Energie umgewandelt – Strom aus dem Nichts wäre unmöglich. Eindrucksvoll zeigt sich das im Kupferrohr, in dem ein Magnet durch Wirbelströme stark gebremst langsam herabgleitet. Anwendungen: Wirbelstrombremse, Induktionsherd, Rekuperation im E-Auto.' },
          { name:'Wie erzeugt ein Kraftwerk ununterbrochen Strom?', diff:2, video:'generator-jg10.mp4', explanation:'Der Generator ist ein umgekehrter Elektromotor: Statt Strom hineinzuschicken, dreht man die Spule im Magnetfeld – dadurch ändert sich das Feld durch die Spule ständig und es wird laufend eine Spannung induziert. Bei jeder halben Umdrehung kehrt sich die Spannung um: Es entsteht eine sinusförmige Wechselspannung. Zwei durchgehende Schleifringe greifen sie ab (ein geteilter Ring/Kommutator würde Gleichstrom liefern). Schnelleres Drehen erhöht Spannung und Frequenz – das Netz braucht konstant 50 Hz. In Kohle-, Wind- und Wasserkraftwerken sowie im Fahrraddynamo dreht am Ende immer etwas einen Generator.' },
          { name:'Warum wechselt der Strom aus der Steckdose die Richtung?', diff:2, video:'wechselspannung.mp4', explanation:'Eine Batterie liefert eine gleichbleibende Gleichspannung. Die Steckdose liefert Wechselspannung: Sie steigt, fällt und kehrt ständig die Richtung um – als Sinuskurve. In Europa geschieht das 50-mal pro Sekunde (Frequenz 50 Hertz, 230 Volt). Wichtig gegen den Denkfehler: Die Elektronen wandern nicht durch die Leitung davon, sondern schwingen nur hin und her. Der große Vorteil von Wechselstrom: Nur er lässt sich mit einem Transformator einfach hoch- und heruntersetzen.' },
          { name:'Wann braucht man Gleichstrom, wann Wechselstrom?', diff:2, video:'gleich-wechselstrom.mp4', explanation:'Gleichstrom (DC) fließt immer in dieselbe Richtung; Batterien und Akkus liefern ihn, und alle elektronischen Geräte (Handy, LED, Chips) brauchen konstante Gleichspannung. Wechselstrom (AC) wechselt ständig die Richtung; Generatoren liefern ihn und er kommt aus der Steckdose – sein Vorteil ist die einfache Umwandlung mit dem Transformator, ideal für den Transport über weite Strecken. Ein Netzteil/Ladegerät wandelt Wechselstrom in Gleichstrom um (Gleichrichter). Umgekehrt macht ein Wechselrichter aus dem Gleichstrom einer Solaranlage netztauglichen Wechselstrom.' },
          { name:'Wie ändere ich eine Spannung, ohne Energie zu verschwenden?', diff:2, video:'transformator.mp4', explanation:'Ein Transformator hat zwei Spulen (Primär und Sekundär) auf einem gemeinsamen Eisenkern; sie berühren sich elektrisch nicht, verbunden sind sie nur durch das Magnetfeld im Kern. Der Wechselstrom in der Primärspule erzeugt im Eisenkern ein ständig wechselndes Feld, das in der Sekundärspule eine Spannung induziert – die Energie springt berührungslos über. Wichtig: Das funktioniert nur mit Wechselstrom. Gleichstrom liefert ein konstantes Feld, und ohne Änderung wird nichts induziert. Transformatoren stecken in Netzteilen, Umspannwerken und Klingeltrafos.' },
          { name:'Wie hängen Windungszahl und Spannung zusammen?', diff:2, video:'uebersetzungsverhaeltnis.mp4', explanation:'Am Transformator gilt: Die Spannungen verhalten sich wie die Windungszahlen – U₁/U₂ = N₁/N₂. Mehr Windungen auf der Sekundärseite → höhere Spannung (Hochtransformieren, z. B. für Überlandleitungen); weniger Windungen → kleinere Spannung (Heruntertransformieren, z. B. 230 V auf 12 V im Netzteil). Ein Transformator schenkt aber keine Energie: Steigt die Spannung, sinkt im gleichen Maß die Stromstärke, denn die Leistung P = U · I bleibt (nahezu) erhalten.' },
          { name:'Warum geht auf langen Leitungen Energie verloren?', diff:2, video:'leitungsverluste.mp4', explanation:'Jede Leitung hat einen Widerstand R. Fließt Strom, wird an ihm Energie in Wärme umgewandelt – die Leitung erwärmt sich, und diese Wärme geht als Nutzenergie verloren. Es gilt die Verlustformel P_Verlust = R · I². Je länger und dünner das Kabel, desto größer R. Entscheidend ist aber die Stromstärke: Weil das I im Quadrat steht, führt doppelter Strom nicht zu doppeltem, sondern zu vierfachem Verlust. Um Verluste zu vermeiden, muss man die Stromstärke klein halten – das gelingt mit hoher Spannung.' },
          { name:'Warum transportiert man Strom mit Hochspannung?', diff:2, video:'hochspannung.mp4', explanation:'Der Verlust wächst mit dem Quadrat der Stromstärke, also muss man den Strom klein halten. Weil P = U · I gilt, transformiert man vor der langen Leitung die Spannung hoch – dadurch sinkt bei gleicher übertragener Leistung die Stromstärke stark, und es geht kaum Energie verloren. Bei niedriger Spannung bräuchte man viel Strom, die Leitung würde heiß. Deshalb führen Überlandleitungen Höchstspannung (220–380 kV). So hohe Spannung ist im Haushalt gefährlich und wird vor dem Verbraucher wieder auf 230 V heruntertransformiert.' },
          { name:'Wie kommt der Strom vom Kraftwerk in die Steckdose?', diff:2, video:'stromnetz.mp4', explanation:'Der Strom legt eine weite Reise zurück: Im Kraftwerk erzeugt ein Generator ihn (≈ 25 kV), ein Hochtransformator setzt ihn auf 380 kV hoch für den verlustarmen Transport über Höchstspannungsleitungen. Danach senken mehrere Umspannwerke die Spannung stufenweise – 110 kV (Regionen/Industrie), 20 kV (Stadtteile) – bis der Ortsnetztransformator die 230 V für den Haushalt liefert. Das Netz vereint beides: hohe Spannung zum Transportieren, niedrige Spannung zum sicheren Nutzen. Es liefert rund um die Uhr Strom und nimmt zunehmend Solar- und Windenergie auf.' },
          { isChapter:true, name:'☢️ Radioaktivität, Kernphysik & Verantwortung' },
          { name:'Woraus besteht ein Atom?', diff:2, video:'atombau.mp4', explanation:'Ein Atom hat einen winzigen, schweren Kern und eine weite Elektronenhülle. Rutherford zeigte das mit dem Streuversuch: Fast alle Teilchen fliegen durch eine Goldfolie (das Atom ist fast leer), nur wenige prallen zurück (in der Mitte sitzt der winzige, dichte Kern). Das Atom ist rund 100 000-mal größer als sein Kern. Bausteine: Protonen (positiv) und Neutronen (neutral) im Kern, Elektronen (negativ) in der Hülle. Ein neutrales Atom hat gleich viele Protonen wie Elektronen. Die Radioaktivität entsteht tief im Kern.' },
          { name:'Warum gibt es vom selben Element verschiedene Sorten?', diff:2, video:'kernaufbau.mp4', explanation:'Die Zahl der Protonen (Ordnungszahl) bestimmt das Element eindeutig: 1 = Wasserstoff, 2 = Helium, 3 = Lithium. Protonen + Neutronen = Massenzahl (fast die ganze Atommasse steckt im Kern). Isotope sind Varianten desselben Elements mit gleicher Protonenzahl, aber verschiedener Neutronenzahl – z. B. C-12 (6p, 6n) und C-14 (6p, 8n). Schreibweise: Massenzahl oben, Ordnungszahl unten vor dem Symbol; Neutronenzahl = Massenzahl − Ordnungszahl.' },
          { name:'Warum zerfallen manche Atomkerne von selbst?', diff:2, video:'stabil-instabil.mp4', explanation:'Im Kern wirken zwei Kräfte gegeneinander: Die positiven Protonen stoßen sich elektrisch ab, die starke Kernkraft hält alles zusammen – aber nur auf sehr kurze Entfernung. Stimmt das Verhältnis von Protonen und Neutronen und ist der Kern nicht zu groß, überwiegt der Zusammenhalt: Der Kern ist stabil. Wird der Kern zu groß oder unausgewogen, reicht die kurzreichweitige Kernkraft nicht mehr aus – er ist instabil und zerfällt von selbst. Dabei stößt er ein Teilchen oder Energie ab und wird stabiler: Das ist radioaktive Strahlung.' },
          { name:'Woher kommt eine Strahlung, die niemand sehen kann?', diff:2, video:'natuerliche-radioaktivitaet.mp4', explanation:'1896 entdeckte Henri Becquerel die natürliche Radioaktivität: Uransalz schwärzte eine lichtdicht verpackte Fotoplatte – ganz ohne Licht. Das Material sendet also von selbst eine Strahlung aus. Diese Strahlung kann man mit keinem Sinn wahrnehmen (nicht sehen, riechen, schmecken, fühlen) – nur mit Messgeräten. Sie ist überall: in Gestein und Boden (Radon), als Höhenstrahlung aus dem Weltall, in der Nahrung (Kalium-40) und sogar im eigenen Körper. Wichtig: Der Mensch hat sie nicht erfunden – sie ist so alt wie die Erde und meist harmlos gering.' },
          { name:'Was macht diese Strahlung so besonders (und gefährlich)?', diff:2, video:'ionisierende-strahlung.mp4', explanation:'Radioaktive Strahlung ist ionisierende Strahlung: Sie trägt so viel Energie, dass sie Elektronen aus Atomen herausschlägt. Zurück bleibt ein geladenes Atom – ein Ion. Trifft sie lebende Zellen, kann sie Moleküle und das Erbgut (DNA) schädigen; das macht sie gefährlich. Entscheidend ist aber die Dosis: Die kleine natürliche Strahlung, eine Banane oder ein Flug sind unbedenklich, erst eine hohe Dosis wird gefährlich. Weil sie ionisiert, kann man sie messen und in der Medizin gezielt nutzen.' },
          { name:'Wie macht man unsichtbare Strahlung sichtbar?', diff:2, video:'strahlung-nachweisen.mp4', explanation:'Man nutzt die Ionisation. Im Geigerzähler ionisiert ein Teilchen das Gas im Zählrohr, es entsteht ein kurzer Stromstoß und man hört ein Klick. Je mehr Strahlung, desto mehr Klicks pro Sekunde – diese Zählrate misst die Aktivität (in Becquerel). In der Nebelkammer hinterlässt jedes Teilchen eine sichtbare Nebelspur; an Länge und Dicke erkennt man die Strahlungsart (Alpha dick/kurz, Beta dünn/lang). Zum dauerhaften Schutz tragen Menschen Filmplaketten oder Dosimeter, die die gesammelte Dosis messen.' },
          { name:'Was ist Alphastrahlung und wie weit kommt sie?', diff:2, video:'alphastrahlung.mp4', explanation:'Ein Alphateilchen (α) besteht aus 2 Protonen und 2 Neutronen – das ist ein Heliumkern, positiv geladen und relativ schwer. Beim Alphazerfall verliert der Kern diese 4 Bausteine: Die Ordnungszahl sinkt um 2, die Massenzahl um 4, es entsteht ein neues Element (z. B. Radium-226 → Radon-222). Weil α-Teilchen groß und geladen sind, haben sie eine sehr kurze Reichweite – ein Blatt Papier oder die Haut stoppt sie. Denkfehler: Von außen ist Alphastrahlung kaum gefährlich, aber im Körper (eingeatmet/verschluckt) besonders schädlich.' },
          { name:'Warum ist Betastrahlung durchdringender?', diff:2, video:'betastrahlung.mp4', explanation:'Bei der Betastrahlung (β) wandelt sich im Kern ein Neutron in ein Proton und ein Elektron um (n⁰ → p⁺ + e⁻). Das schnelle Elektron schießt aus dem Kern heraus – das ist die Betastrahlung. Der Kern hat danach ein Proton mehr: Die Ordnungszahl steigt um 1, die Massenzahl bleibt gleich (z. B. C-14 → Stickstoff-14). Weil das Elektron viel leichter und schneller ist als ein Alphateilchen, kommt es weiter: Es durchdringt Papier, wird aber von einigen Millimetern Aluminium gestoppt.' },
          { name:'Wieso stoppt selbst Blei die Gammastrahlung kaum?', diff:2, video:'gammastrahlung.mp4', explanation:'Gammastrahlung (γ) ist kein Teilchen, sondern eine energiereiche elektromagnetische Welle – verwandt mit Licht und Röntgenstrahlung, ohne Masse und Ladung. Beim Aussenden ändern sich Ordnungszahl und Massenzahl nicht; der Kern gibt nur überschüssige Energie ab (oft direkt nach einem α- oder β-Zerfall), das Element bleibt gleich. Weil sie keine Masse und Ladung hat, durchdringt sie Papier und Aluminium mühelos – erst dickes Blei oder Beton schwächt sie deutlich ab; ganz stoppen kann man sie kaum.' },
          { name:'Womit kann ich welche Strahlung aufhalten?', diff:2, video:'abschirmung.mp4', explanation:'Die drei Strahlungsarten unterscheiden sich in Reichweite und Abschirmung: Alphastrahlung stoppt schon ein Blatt Papier (oder die Haut). Betastrahlung durchdringt Papier, wird aber von einigen Millimetern Aluminium gestoppt. Gammastrahlung durchdringt Papier und Alu mühelos – erst dickes Blei oder Beton schwächt sie deutlich ab. Die Reichweite nimmt also von α über β zu γ zu, und je durchdringender die Strahlung, desto mehr Abschirmung braucht man (Bleischürze beim Röntgen, Betonwände am Reaktor).' },
          { name:'Wie unterscheide ich die drei Strahlungsarten?', diff:2, video:'ablenkung-feld.mp4', explanation:'Man schickt die Strahlung durch ein elektrisches (oder magnetisches) Feld, z. B. zwischen eine positive und eine negative Platte. Dort teilt sie sich in drei Richtungen: Alphastrahlung ist positiv geladen und wird leicht zur negativen Platte abgelenkt; Betastrahlung ist negativ geladen und wird stärker zur positiven Platte abgelenkt (stärker, weil das Elektron viel leichter ist); Gammastrahlung hat keine Ladung und fliegt geradeaus weiter. So lassen sich α, β und γ eindeutig unterscheiden.' },
          { name:'Was wird aus einem Kern nach dem Zerfall?', diff:2, video:'zerfallsgleichung.mp4', explanation:'Beim Zerfall wird aus einem Kern ein neues Element – nichts geht verloren. In der Zerfallsgleichung (Massenzahl oben, Ordnungszahl unten) muss die Summe auf beiden Seiten gleich sein. Alphazerfall: ²²⁶₈₈Ra → ²²²₈₆Rn + ⁴₂He (Ordnungszahl −2, Massenzahl −4). Betazerfall: ¹⁴₆C → ¹⁴₇N + e⁻ (Ordnungszahl +1, Massenzahl gleich; das Elektron trägt die Ladung −1). Oft ist der neue Kern selbst noch instabil und zerfällt weiter – so entsteht eine Zerfallsreihe (z. B. Uran-238 über viele Schritte bis zum stabilen Blei-206).' },
          { name:'Warum kann man nie sagen, WANN ein Kern zerfällt?', diff:2, video:'halbwertszeit.mp4', explanation:'Ob ein einzelner Kern gleich oder erst in tausend Jahren zerfällt, ist reiner Zufall – wie beim Popcorn weiß man nicht, welches Korn wann aufplatzt. Bei sehr vielen Kernen wird der Zufall aber berechenbar: Die Halbwertszeit T ist die Zeit, in der die Hälfte aller Kerne zerfällt. Nach T ist die Hälfte übrig, nach 2·T ein Viertel, nach 3·T ein Achtel (N(t) = N₀·(1/2)^(t/T)). Vorsicht: Nach zwei Halbwertszeiten ist nicht alles weg, sondern noch ein Viertel da. Jeder Stoff hat seine eigene Halbwertszeit – von Sekunden bis Milliarden Jahren.' },
          { name:'Wie bestimmt man das Alter von Ötzi oder eines Baumes?', diff:2, video:'c14-methode.mp4', explanation:'Mit der C-14-Methode. In der Luft gibt es etwas radioaktives C-14; jedes Lebewesen nimmt es ständig auf, solange es lebt – der Anteil bleibt konstant. Nach dem Tod wird kein neues C-14 mehr aufgenommen, das vorhandene zerfällt mit einer Halbwertszeit von 5 730 Jahren. Aus dem verbliebenen Anteil bestimmt man das Alter: noch 50 % → 1 Halbwertszeit (≈ 5 730 Jahre), 25 % → 2 (≈ 11 460 Jahre). Bei Ötzi war noch etwa die Hälfte übrig → rund 5 300 Jahre alt. Die Methode reicht bis etwa 50 000 Jahre; für ältere Funde nutzt man Isotope mit längerer Halbwertszeit.' },
          { name:'Wie hilft radioaktive Strahlung in der Medizin?', diff:2, video:'medizin-strahlung.mp4', explanation:'Strahlung hilft in der Medizin doppelt. Diagnose: Man spritzt einen schwach radioaktiven Marker, der sich in einem Organ anreichert und Gammastrahlung aussendet; eine Gammakamera macht daraus ein Bild (z. B. Szintigrafie/PET). Therapie: Bei Krebs richtet man einen starken Strahl aus vielen Richtungen genau auf den Tumor – nur im Kreuzungspunkt ist die Dosis hoch genug, um die kranken Zellen zu zerstören, das gesunde Gewebe wird geschont. Außerdem macht Gammastrahlung Operationsbesteck keimfrei. So entstand das Fachgebiet der Nuklearmedizin.' },
          { name:'Wo nutzt die Technik radioaktive Strahlung?', diff:2, video:'technik-strahlung.mp4', explanation:'Je nach Aufgabe nutzt man die passende Strahlungsart. Materialprüfung: Gammastrahlung durchleuchtet ein Werkstück wie eine Röntgenaufnahme – an einem Riss kommt mehr Strahlung durch, der Fehler wird auf dem Film sichtbar (z. B. Schweißnähte, zerstörungsfrei). Dickenmessung: Über einer laufenden Folie sitzt eine Betaquelle, darunter ein Detektor; je dicker das Material, desto weniger Strahlung kommt durch – die Maschine regelt berührungslos nach. Rauchmelder: Eine winzige Alphaquelle ionisiert die Luft (kleiner Strom); Rauch bremst die Ionen, der Strom sinkt und der Alarm geht los. Auch Lebensmittel-Haltbarmachung und Füllstandsmessung nutzen Strahlung.' },
          { name:'Wie viel Strahlung steckt in meinem Alltag?', diff:2, video:'strahlenbelastung.mp4', explanation:'Die Strahlendosis misst man in Millisievert (mSv); sie berücksichtigt Menge und Schädlichkeit im Gewebe. Wir sind ständig einer natürlichen Belastung ausgesetzt – in Deutschland im Schnitt etwa 2–4 mSv pro Jahr. Größte Quellen: Radon in der Atemluft (≈ 1,1 mSv) und medizinische Untersuchungen (Ø ≈ 1,9 mSv), dazu Boden/Baustoffe, Höhenstrahlung und Nahrung. Zum Vergleich: eine Banane liefert winzige Mengen, ein Fernflug etwas mehr, eine Röntgenaufnahme der Lunge ≈ 0,1 mSv, ein CT ≈ 2 mSv. Die kleine natürliche Belastung ist unbedenklich; gefährlich wird erst eine hohe Dosis.' },
          { name:'Wie schütze ich mich am wirksamsten vor Strahlung?', diff:2, video:'strahlenschutz.mp4', explanation:'Drei einfache Regeln: (1) Zeit – die Dosis summiert sich, also möglichst kurz in der Nähe einer Quelle bleiben. (2) Abstand – die Strahlung verteilt sich mit der Entfernung auf eine größere Fläche; verdoppelt man den Abstand, sinkt die Dosis auf ein Viertel (Abstand hilft am meisten). (3) Abschirmung – passendes Material dazwischen: Papier gegen Alpha, Aluminium gegen Beta, dickes Blei oder Beton gegen Gamma. Dazu eine vierte, wichtige Regel: strahlende Stoffe niemals einatmen oder verschlucken, denn im Körper wirkt die Strahlung ungebremst.' },
          { name:'Wie holt man riesige Energie aus einem winzigen Kern?', diff:2, video:'kernspaltung.mp4', explanation:'Bei der Kernspaltung trifft ein langsames Neutron einen Uran-235-Kern. Der wird instabil und spaltet sich in zwei kleinere Kerne, setzt zwei bis drei neue Neutronen frei – und dabei sehr viel Energie. Woher kommt die Energie? Die Bruchstücke wiegen zusammen ein winziges bisschen weniger als der Ausgangskern; diese fehlende Masse wird nach Einsteins Formel E = m·c² in Energie umgewandelt. Zum Vergleich: 1 g Uran liefert etwa so viel Energie wie 3 Tonnen Kohle.' },
          { name:'Wie verhindert man, dass eine Kettenreaktion außer Kontrolle gerät?', diff:2, video:'kettenreaktion.mp4', explanation:'Die bei einer Spaltung frei werdenden Neutronen lösen weitere Spaltungen aus: 1 → 2 → 4 → 8 … eine Kettenreaktion. Ungebremst verdoppelt sie sich blitzschnell (das ist das Prinzip der Atombombe). Im Reaktor sorgen Steuerstäbe (z. B. aus Bor) für Kontrolle: Sie fangen die überzähligen Neutronen ab, sodass von jeder Spaltung genau eine neue folgt – die Reaktion läuft ruhig und gleichmäßig. Ein Moderator bremst die Neutronen ab; im Notfall stoppen ganz eingefahrene Steuerstäbe die Reaktion.' },
          { name:'Wie wird aus Kernspaltung Strom in meiner Steckdose?', diff:2, video:'kernkraftwerk.mp4', explanation:'Im Reaktor läuft die kontrollierte Kettenreaktion und erzeugt sehr viel Wärme. Diese Wärme verdampft Wasser; der heiße Dampf treibt eine Turbine, die einen Generator dreht, und der erzeugt durch Induktion den Strom. Wichtig: Ein Kernkraftwerk erzeugt Strom nicht direkt aus der Spaltung – es funktioniert wie ein Kohlekraftwerk (Dampf → Turbine → Generator), nur dass die Wärme aus der Kernspaltung statt aus dem Verbrennen kommt. Ein Kühlturm gibt Restwärme ab, eine dicke Betonhülle schirmt die Strahlung ab.' },
          { name:'Was passiert, wenn ein Reaktor außer Kontrolle gerät?', diff:2, video:'reaktorunfaelle.mp4', explanation:'Ein Reaktor muss ständig gekühlt werden. Fällt die Kühlung aus, überhitzt er und die Brennstäbe schmelzen – eine Kernschmelze, bei der radioaktives Material freigesetzt werden kann. Zwei große Unfälle: Tschernobyl 1986 (der Reaktor explodierte bei einem Test und setzte enorme Radioaktivität frei) und Fukushima 2011 (ein Erdbeben und ein Tsunami zerstörten die Kühlung → mehrere Kernschmelzen). Die Folgen sind weiträumig und langfristig: Sperrzonen, Evakuierungen, Kontamination über Jahrzehnte. Deshalb haben Reaktoren mehrfache Schutzhüllen und redundante Notkühlsysteme.' },
          { name:'Wohin mit dem Müll, der noch Tausende Jahre strahlt?', diff:2, video:'endlagerung.mp4', explanation:'Verbrauchte Brennstäbe sind hochradioaktiv; manche Stoffe darin strahlen noch Zehntausende bis Hunderttausende Jahre. So lange muss der Müll sicher von Mensch und Umwelt getrennt bleiben. Die geplante Lösung ist ein Endlager tief unter der Erde, in einer stabilen Gesteinsschicht (Salz, Ton oder Granit), die sich über sehr lange Zeit kaum verändert. Die größte Schwierigkeit ist die Zeit: Der Müll muss länger sicher bleiben, als es überhaupt Schrift gibt – wie warnt man ferne Generationen? Bis ein Endlager bereitsteht, lagert der Müll in gekühlten Zwischenlagern. Die Endlagerung ist eine der größten ungelösten Aufgaben der Kernenergie.' },
          { name:'Woher nimmt die Sonne ihre Energie – und können wir das nachbauen?', diff:2, video:'kernfusion.mp4', explanation:'Bei der Kernfusion verschmelzen zwei leichte Kerne (z. B. die Wasserstoffsorten Deuterium und Tritium) zu einem Heliumkern – dabei entsteht ein Neutron und sehr viel Energie. Das ist die Energiequelle der Sonne und aller Sterne (bei Millionen Grad und riesigem Druck). Fusion und Spaltung sind Gegenteile: Fusion fügt leichte Kerne zusammen, Spaltung zerteilt schwere. Vorteil der Fusion: fast unbegrenzter Brennstoff (Wasserstoff aus Wasser) und kaum langlebiger Müll. Auf der Erde ist sie extrem schwer: Man braucht über 100 Mio. Grad, und ein starkes Magnetfeld hält das Plasma berührungslos (Forschungsanlagen wie ITER).' },
          { name:'Kernenergie: Segen oder Gefahr?', diff:2, video:'bewertung-kernenergie.mp4', explanation:'Kernenergie hat große Chancen UND große Risiken – deshalb muss man sie sachlich abwägen. Chancen: kaum CO₂ (Klimaschutz), viel Energie aus wenig Brennstoff, zuverlässige Grundlast rund um die Uhr, kein Feinstaub. Risiken: Gefahr schwerer Unfälle (Tschernobyl, Fukushima), hochradioaktiver Müll ohne sicheres Endlager, begrenztes und abzubauendes Uran, hohe Kosten für Bau/Sicherheit/Rückbau. Legt man beides auf eine Waage, gibt es keinen klaren Sieger – wie schwer jede Seite wiegt, hängt von den eigenen Werten ab, deshalb entscheiden Länder unterschiedlich. Die Frage ist keine reine Physik-, sondern auch eine Wertefrage. Eine gute Bewertung braucht: Fakten kennen, Werte abwägen, an die Zukunft denken – und sich ein eigenes, begründetes Urteil bilden.' },
