    ...
    subjects:[
      ...
      },
      {
        ...
        topics:[
          ...
          { name:'Was passiert, wenn zwei Kräfte gleichzeitig ziehen?', diff:2, exp:'kraefte-addieren', explanation:'Wirken zwei Kräfte an einem Körper, so rechnet man sie zu einer Gesamtkraft (Resultierenden) zusammen. In der Simulation stellst du für beide Kräfte Betrag und Richtung ein: Zeigen sie in dieselbe Richtung, werden die Beträge addiert. Zeigen sie in entgegengesetzte Richtungen, werden sie subtrahiert, und die Gesamtkraft zeigt in Richtung der größeren Kraft. Sind zwei gleich große Kräfte entgegengesetzt, ist die Gesamtkraft 0 N – das ist ein Gleichgewicht.' },
          { name:'Warum bewegt sich ein ruhender Körper nicht?', diff:2, exp:'kraefte-gleichgewicht', explanation:'An einer hängenden Lampe ziehen zwei Kräfte: die Gewichtskraft nach unten und die Haltekraft des Seils nach oben. In der Simulation veränderst du die Haltekraft und beobachtest die Gesamtkraft. Sind beide Kräfte gleich groß und entgegengesetzt, ist die Gesamtkraft 0 N – die Lampe bleibt in Ruhe. Das nennt man Kräftegleichgewicht. Ist eine Kraft größer, wird die Gesamtkraft ungleich null und die Lampe bewegt sich. So lernst du: „In Ruhe“ bedeutet nicht „keine Kräfte“, sondern Kräfte, die sich ausgleichen (wie beim Buch auf dem Tisch).' },
          { name:'Kraft und Gegenkraft: Warum drücke ich zurück?', diff:2, exp:'wechselwirkung', explanation:'Kräfte treten immer paarweise auf. Übt ein Körper eine Kraft auf einen anderen aus, so wirkt eine gleich große Kraft zurück – das ist das Wechselwirkungsprinzip (actio = reactio). In der Simulation wählst du ein Beispiel (Eisläufer, Bootssprung, Rakete) und stößt ab: Du siehst zwei gleich große, entgegengesetzte Kraftpfeile und wie beide Partner auseinandergehen. Wichtig: Die zwei Kräfte wirken auf zwei verschiedene Körper – deshalb heben sie sich nicht auf (anders als beim Gleichgewicht). So erklärt sich auch, warum eine Rakete sogar im Weltall fliegt.' },
          { name:'Warum geht ein Stein über eine Rampe leichter hoch?', diff:2, exp:'schiefe-ebene', explanation:'Eine Rampe (schiefe Ebene) ist ein einfacher Kraftwandler. In der Simulation soll eine Last von 6 N auf dieselbe Höhe gebracht werden, und du veränderst die Steilheit der Rampe. Je flacher die Rampe, desto kleiner ist die nötige Zugkraft – dafür wird der Weg länger. Das Produkt Kraft × Weg bleibt bei jeder Rampe gleich und ist genauso groß wie beim senkrechten Heben. Merke: Eine Rampe spart Kraft, aber keine Arbeit – was man an Kraft spart, muss man an Weg zusetzen. Darum haben Rollstuhlrampen und Bergstraßen eine geringe Steigung.' },
          { name:'Warum bremst mich der Boden aus? (Reibung)', diff:1, exp:'reibung-rs', explanation:'Ein rollender Wagen bleibt von selbst stehen, weil die Reibung ihn abbremst. In der Simulation gibst du dem Wagen auf verschiedenen Untergründen (Eis, Holz, Teppich) denselben Anstoß und misst den Auslaufweg. Du erkennst: Die Reibungskraft wirkt immer entgegen der Bewegung. Je rauer der Untergrund, desto größer die Reibung und desto kürzer der Auslaufweg. Ohne Reibung würde der Wagen immer weiterrollen. Reibung ist mal hinderlich (sie bremst) und mal nützlich (Halt beim Gehen, Bremsen, Winterreifen).' },
