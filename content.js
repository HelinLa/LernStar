    ...
    subjects:[
      {
        ...
        topics:[
          ...
          { name:'Zahlen ordnen', diff:1,
            explanation:'Zahlen vergleichen ist eine Grundfertigkeit. Auf dem Zahlenstrahl werden Zahlen von links nach rechts immer größer. Zwei Zahlen vergleichst du mit den Zeichen < (kleiner als), > (größer als) oder = (gleich). Der Vorgänger einer Zahl ist die um 1 kleinere Zahl, der Nachfolger die um 1 größere Zahl. Beim Vergleichen mehrstelliger Zahlen schaust du von links: Mehr Stellen bedeutet größer – 10 000 > 9 999! Bei gleicher Stellenanzahl vergleichst du Stelle für Stelle. Die Mitte zwischen zwei Zahlen berechnest du mit (a + b) ÷ 2.' },
          { name:'Zählen und Darstellen', diff:1,
            explanation:'Daten sammeln und darstellen ist eine wichtige Alltagskompetenz. Mit einer Strichliste zählst du Häufigkeiten – der 5. Strich geht quer durch vier Striche. Aus den Daten erstellst du eine Tabelle und daraus ein Diagramm. Das Säulendiagramm vergleicht Häufigkeiten: Die Höhe jeder Säule zeigt die Anzahl. Die senkrechte Achse (Hochachse / y-Achse) zeigt die Werte, die waagerechte Achse die Kategorien. Beim Lesen von Diagrammen immer auf Achsenbeschriftungen und Maßstab achten!' },
          { name:'Große Zahlen und Runden', diff:2,
            explanation:'In Wissenschaft und Alltag begegnen uns riesige Zahlen: Die Weltbevölkerung beträgt ca. 8 Milliarden. 1 Million = 1 000 000 (6 Nullen), 1 Milliarde = 1 000 000 000 (9 Nullen), 1 Billion = 1 000 000 000 000 (12 Nullen). Unser Zahlensystem heißt Dezimalsystem (lat. decem = zehn). Die Stellenwerttafel hilft beim Lesen großer Zahlen. Runden: Bei der Stelle rechts neben der Rundestelle gilt – 0 bis 4: abrunden, 5 bis 9: aufrunden. Gerundete Zahlen erkennst du oft an vielen Nullen.' },
          { name:'Grundrechenarten – Fachbegriffe', diff:1,
            explanation:'Die vier Grundrechenarten sind Addition (+), Subtraktion (−), Multiplikation (×) und Division (÷). Fachbegriffe: Addition: Summand + Summand = Summe. Subtraktion: Minuend − Subtrahend = Differenz. Multiplikation: Faktor × Faktor = Produkt. Division: Dividend ÷ Divisor = Quotient. Umkehraufgaben: Subtraktion kehrt die Addition um, Division kehrt die Multiplikation um. Durch 0 darf man nie dividieren! Merke: Punkt vor Strich – Multiplikation und Division werden vor Addition und Subtraktion gerechnet.' },
          { name:'Rechnen mit Geld', diff:1,
            explanation:'Geldbeträge schreibt man mit Komma: 5,75 € = 5 Euro und 75 Cent. 1 Euro = 100 Cent. Beim Umrechnen: Cent in Euro → durch 100. Euro in Cent → mal 100. Beim Rechnen immer in derselben Einheit arbeiten. Sachaufgaben löst du in drei Schritten: Aufgabe verstehen (Was ist gegeben? Was gesucht?), Rechenweg durchführen, Ergebnis überprüfen. Tipp: Rechne in Cent um, dann kein Kommafehler möglich!' },
          { name:'Rechnen mit Längenangaben', diff:1,
            explanation:'Längen messen wir in km, m, dm, cm und mm. Umrechnung: 1 km = 1000 m, 1 m = 10 dm = 100 cm = 1000 mm. In die kleinere Einheit: multiplizieren. In die größere: dividieren. Stellenwerttafel: km | m | dm | cm | mm. Kommaschreibweise: 3,40 m = 340 cm. Beim Rechnen mit gemischten Angaben (z. B. 3 m 40 cm) alles in eine Einheit umschreiben. Die Maßzahl wird kleiner, wenn die Maßeinheit größer wird!' },
          { name:'Rechnen mit Gewichtsangaben', diff:1,
            explanation:'Gewichte messen wir in t (Tonne), kg (Kilogramm), g (Gramm) und mg (Milligramm). Umrechnung: 1 t = 1000 kg, 1 kg = 1000 g, 1 g = 1000 mg. "Kilo" = Tausend, "Milli" = Tausendstel. In die kleinere Einheit: × 1000. In die größere: ÷ 1000. Kommaschreibweise: 2,6 kg = 2600 g. Im Alltag: g und kg beim Einkaufen, Tonnen beim Transport, mg in der Medizin und Ernährung.' },
          { name:'Rechnen mit Zeitangaben', diff:1,
            explanation:'Zeitspannen messen wir in d (Tag), h (Stunde), min (Minute) und s (Sekunde). Umrechnung: 1 d = 24 h, 1 h = 60 min, 1 min = 60 s. Unterscheide: Zeitpunkt ("Wann?" → 14:30 Uhr) und Zeitdauer ("Wie lange?" → 2 h 15 min). Beim Berechnen von Zeitspannen nutze den Zahlenstrahl schrittweise: von 9:40 bis 10:00 = 20 min, von 10:00 bis 11:15 = 1 h 15 min. Eine Woche = 7 × 24 = 168 h.' },
        ...
        exercises:[
          ...
          { id:'e10', type:'Geld', diff:1, title:'Rechnen mit Geld',
            ...
            questions:[
              ...
              { q:'Wie viele Cent sind 2,50 €?', hint:'2 Euro = 200 ct, plus 50 ct.', options:['25 ct','205 ct','250 ct','2500 ct'], correct:2, explanation:'2,50 € = 200 ct + 50 ct = 250 ct.' },
              { q:'Schreibe 350 ct in Euro.', hint:'350 ct ÷ 100 = ?', options:['0,35 €','3,05 €','3,50 €','35,00 €'], correct:2, explanation:'350 ct ÷ 100 = 3,50 €.' },
              { q:'Ein Buch kostet 8,90 € und ein Heft 1,50 €. Was kostet beides?', hint:'8,90 + 1,50. In Cent: 890 + 150.', options:['9,40 €','10,40 €','10,90 €','11,40 €'], correct:1, explanation:'8,90 € + 1,50 € = 10,40 €.' },
              { q:'Jonas zahlt mit 5 €. Er kauft Äpfel für 2,30 €. Wie viel Rückgeld?', hint:'5,00 − 2,30 = ?', options:['2,30 €','2,50 €','2,70 €','3,70 €'], correct:2, explanation:'5,00 € − 2,30 € = 2,70 € Rückgeld.' },
              { q:'4 Flaschen à 1,95 €. Was kosten sie zusammen?', hint:'4 × 1,95 € oder in Cent: 4 × 195 ct.', options:['5,80 €','7,80 €','7,95 €','8,20 €'], correct:1, explanation:'4 × 1,95 € = 7,80 €.' },
              { q:'3 gleiche Hefte kosten zusammen 4,50 €. Was kostet ein Heft?', hint:'Division: 4,50 € ÷ 3 = ?', options:['1,05 €','1,50 €','1,75 €','2,25 €'], correct:1, explanation:'4,50 € ÷ 3 = 1,50 € pro Heft.' },
              { q:'Lea spart 12 € pro Monat. Wie viel hat sie nach 8 Monaten?', hint:'8 × 12 € = ?', options:['72 €','84 €','96 €','108 €'], correct:2, explanation:'8 × 12 € = 96 €.' },
            ]
          },
          { id:'e11', type:'Längen', diff:1, title:'Rechnen mit Längenangaben',
            ...
            questions:[
              ...
              { q:'Schreibe in m: 3 km 400 m', hint:'3 km = 3000 m, plus 400 m.', options:['340 m','3040 m','3400 m','34 000 m'], correct:2, explanation:'3 km = 3000 m + 400 m = 3400 m.' },
              { q:'Schreibe in der kleineren Einheit: 2,5 km', hint:'2,5 km × 1000 = ?', options:['250 m','2500 m','25 000 m','250 000 m'], correct:1, explanation:'2,5 km × 1000 = 2500 m.' },
              { q:'Berechne: 6 m − 70 cm. Ergebnis in cm?', hint:'6 m = 600 cm. 600 − 70 = ?', options:['53 cm','530 cm','590 cm','5300 cm'], correct:1, explanation:'6 m = 600 cm. 600 cm − 70 cm = 530 cm (= 5 m 30 cm).' },
              { q:'Schreibe als Kommazahl in cm: 85 mm', hint:'85 mm ÷ 10 = ? cm', options:['0,85 cm','8,5 cm','85 cm','850 cm'], correct:1, explanation:'85 mm ÷ 10 = 8,5 cm.' },
              { q:'6 Autos à 3 m 80 cm hintereinander – wie lang ist der Waggon?', hint:'6 × 380 cm = ? cm. Dann in m umrechnen.', options:['21 m 80 cm','22 m 80 cm','23 m','24 m 80 cm'], correct:1, explanation:'6 × 380 cm = 2280 cm = 22 m 80 cm.' },
            ]
          },
          { id:'e12', type:'Gewichte', diff:1, title:'Rechnen mit Gewichtsangaben',
            ...
            questions:[
              ...
              { q:'Schreibe in g: 0,5 kg', hint:'0,5 kg = halbes Kilogramm = ? g.', options:['5 g','50 g','500 g','5000 g'], correct:2, explanation:'0,5 kg × 1000 = 500 g.' },
              { q:'Schreibe als Kommazahl in kg: 4500 g', hint:'4500 g ÷ 1000 = ?', options:['0,45 kg','4,5 kg','45 kg','450 kg'], correct:1, explanation:'4500 g ÷ 1000 = 4,5 kg.' },
              { q:'Berechne: 23 kg − 2800 g. Ergebnis in kg und g?', hint:'23 kg = 23 000 g. 23 000 − 2800 = ?', options:['2 kg 200 g','20 kg 200 g','20 kg 800 g','21 kg 200 g'], correct:1, explanation:'23 000 g − 2800 g = 20 200 g = 20 kg 200 g.' },
              { q:'40 Schüler × 150 g Nudeln pro Person – wie viele kg?', hint:'40 × 150 g = ? g. Dann ÷ 1000.', options:['4 kg','6 kg','60 kg','600 kg'], correct:1, explanation:'40 × 150 g = 6000 g = 6 kg.' },
              { q:'Ein Hund bekommt täglich 85 g Futter. Wie viele Tage reicht ein 2,55-kg-Sack?', hint:'2,55 kg = 2550 g. 2550 ÷ 85 = ?', options:['25 Tage','30 Tage','35 Tage','40 Tage'], correct:1, explanation:'2550 g ÷ 85 g = 30 Tage.' },
            ]
          },
          { id:'e13', type:'Zeit', diff:1, title:'Rechnen mit Zeitangaben',
            ...
            questions:[
              ...
              { q:'Schreibe in Minuten: 3 h 45 min', hint:'3 h = 3 × 60 = 180 min, plus 45 min.', options:['165 min','205 min','225 min','345 min'], correct:2, explanation:'3 × 60 + 45 = 180 + 45 = 225 min.' },
              { q:'Berechne: 47 min + 38 min. Ergebnis in h und min?', hint:'47 + 38 = 85 min. 85 min = 1 h + ? min.', options:['1 h 15 min','1 h 25 min','1 h 35 min','1 h 45 min'], correct:1, explanation:'85 min = 60 min + 25 min = 1 h 25 min.' },
              ...
              { q:'Zug fährt 9:40 Uhr ab, kommt 11:15 Uhr an. Wie lang ist die Fahrt?', hint:'Von 9:40 bis 10:00 = 20 min. Von 10:00 bis 11:15 = 1 h 15 min.', options:['1 h 25 min','1 h 35 min','1 h 45 min','2 h 5 min'], correct:1, explanation:'20 min + 1 h 15 min = 1 h 35 min.' },
              { q:'Wie viele Stunden hat eine Woche?', hint:'7 Tage × 24 h = ?', options:['144 h','158 h','168 h','184 h'], correct:2, explanation:'7 × 24 = 168 Stunden pro Woche.' },
            ]
          },
          { id:'e14', type:'Statistik', diff:1, title:'Zählen und Darstellen',
            ...
            questions:[
              ...
              { q:'Klasse 5b: blond=14, rot=2, braun=7, schwarz=4. Wie viele Schüler insgesamt?', hint:'14 + 2 + 7 + 4 = ?', options:['25','27','29','31'], correct:1, explanation:'14 + 2 + 7 + 4 = 27 Schüler.' },
