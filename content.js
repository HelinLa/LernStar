    ...
    subjects:[
      {
        ...
        topics:[
          ...
          { name:'Terme', diff:1,
            explanation:'Ein Term ist ein mathematischer Ausdruck aus Zahlen, Rechenzeichen und ggf. Klammern. Rechenregeln: 1. Klammern zuerst (innere zuerst). 2. Potenzen zuerst. 3. Punkt vor Strich: × und ÷ vor + und −. 4. Von links nach rechts. Beispiel: 4 + 3 · 5 = 4 + 15 = 19. Fachbegriffe: Summe, Differenz, Produkt, Quotient.' },
          ...
          { name:'Potenzieren', diff:2,
            explanation:'Eine Potenz aⁿ ist eine Kurzschreibweise für n-maliges Multiplizieren der Grundzahl a. Die Grundzahl heißt auch Basis, die Hochzahl auch Exponent. Potenzen werden vor allen anderen Rechenoperationen ausgeführt (außer Klammern). Quadratzahlen entstehen mit Hochzahl 2: 1, 4, 9, 16, 25, 36, 49, 64, 81, 100 … Zehnerpotenzen: 10¹=10, 10²=100, 10³=1000.' },
          { name:'Teilbarkeit', diff:2,
            explanation:'Teilbarkeitsregeln: ÷2: letzte Ziffer gerade (0,2,4,6,8). ÷5: letzte Ziffer 0 oder 5. ÷10: letzte Ziffer 0. ÷3: Quersumme durch 3 teilbar. ÷4: letzte zwei Ziffern durch 4 teilbar. Quersumme = Summe aller Ziffern. Beispiel: 4578 → Quersumme 4+5+7+8=24, teilbar durch 3.' },
          ...
          { name:'Flächeneinheiten', diff:1,
            explanation:'Flächeneinheiten: mm², cm², dm², m², a (Ar), ha (Hektar), km². Umrechnung von klein nach groß: ÷ 100 (außer m² → a: ÷ 100, a → ha: ÷ 100). Von groß nach klein: × 100. Merkhilfe: 1 cm² = 100 mm², 1 dm² = 100 cm², 1 m² = 100 dm², 1 a = 100 m², 1 ha = 100 a = 10 000 m², 1 km² = 100 ha.' },
          ...
          { name:'Umfang von Figuren', diff:1,
            explanation:'Der Umfang ist die Summe aller Seitenlängen. Rechteck: U = 2 · a + 2 · b = 2 · (a + b). Quadrat: U = 4 · a. Um eine fehlende Seite zu berechnen: b = U ÷ 2 − a. Umfang und Flächeninhalt sind unabhängig voneinander – z.B. können zwei Rechtecke denselben Umfang aber verschiedene Flächen haben.' },
          { name:'Maßstäbe', diff:2,
            explanation:'Ein Maßstab gibt an, wie eine Länge in einer Zeichnung zur Wirklichkeit verhält. Maßstab 1:100 bedeutet: 1 cm in der Zeichnung = 100 cm = 1 m in der Wirklichkeit. Wirkliche Länge = Kartenlänge × Maßstabszahl. Kartenlänge = Wirkliche Länge ÷ Maßstabszahl. Typische Maßstäbe: Stadtplan 1:25 000, Straßenkarte 1:100 000, Landkarte 1:1 000 000.' },
          { name:'Körper und Netze', diff:1,
            explanation:'Geometrische Körper sind dreidimensionale Objekte. Wichtige Körper: Würfel (6 Quadratflächen), Quader (6 Rechteckflächen), Pyramide (1 Grundfläche + Dreiecksflächen), Zylinder (2 Kreisflächen + Mantel), Kegel (1 Kreisfläche + Mantel), Kugel (1 gekrümmte Fläche). Das Netz eines Körpers entsteht, wenn man ihn aufklappt – alle Flächen liegen dann flach in einer Ebene. Aus dem Netz lässt sich der Körper wieder zusammenfalten.' },
